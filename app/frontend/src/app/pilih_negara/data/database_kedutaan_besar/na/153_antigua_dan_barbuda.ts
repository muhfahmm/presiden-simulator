import { antigua_dan_barbudaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/153_antigua_dan_barbuda";

export const antigua_dan_barbudaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = antigua_dan_barbudaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
