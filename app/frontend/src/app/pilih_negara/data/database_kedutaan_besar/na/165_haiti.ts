import { haitiAgreements } from "@/app/database/data/database_mitra_perdagangan/na/165_haiti";

export const haitiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = haitiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
