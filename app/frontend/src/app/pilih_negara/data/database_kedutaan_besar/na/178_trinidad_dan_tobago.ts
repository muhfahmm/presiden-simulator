import { trinidad_dan_tobagoAgreements } from "@/app/database/data/database_mitra_perdagangan/na/178_trinidad_dan_tobago";

export const trinidad_dan_tobagoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = trinidad_dan_tobagoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
