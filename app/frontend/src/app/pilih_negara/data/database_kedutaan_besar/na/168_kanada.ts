import { kanadaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/168_kanada";

export const kanadaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kanadaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
