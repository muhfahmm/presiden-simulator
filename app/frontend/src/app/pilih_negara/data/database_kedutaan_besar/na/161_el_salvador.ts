import { el_salvadorAgreements } from "@/app/database/data/database_mitra_perdagangan/na/161_el_salvador";

export const el_salvadorEmbassyConfig = (playerCountry: string) => {
  const hasTrade = el_salvadorAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
