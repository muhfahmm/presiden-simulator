import { republik_dominikaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/174_republik_dominika";

export const republik_dominikaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_dominikaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
