import { meksikoAgreements } from "@/app/database/data/database_mitra_perdagangan/na/170_meksiko";

export const meksikoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = meksikoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
