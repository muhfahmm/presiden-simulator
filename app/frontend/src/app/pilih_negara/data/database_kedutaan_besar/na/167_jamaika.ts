import { jamaikaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/167_jamaika";

export const jamaikaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = jamaikaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
