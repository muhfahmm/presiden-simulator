import { saint_luciaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/176_saint_lucia";

export const saint_luciaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = saint_luciaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
