import { grenadaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/163_grenada";

export const grenadaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = grenadaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
