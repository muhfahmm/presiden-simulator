import { costa_ricaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/158_costa_rica";

export const costa_ricaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = costa_ricaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
