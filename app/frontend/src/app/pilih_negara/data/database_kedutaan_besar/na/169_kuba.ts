import { kubaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/169_kuba";

export const kubaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kubaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
