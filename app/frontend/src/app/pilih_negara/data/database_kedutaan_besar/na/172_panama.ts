import { panamaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/172_panama";

export const panamaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = panamaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
