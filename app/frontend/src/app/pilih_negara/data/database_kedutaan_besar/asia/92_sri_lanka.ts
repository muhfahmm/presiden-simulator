import { sri_lankaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/92_sri_lanka";

export const sri_lankaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = sri_lankaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
