import { qatarAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/89_qatar";

export const qatarEmbassyConfig = (playerCountry: string) => {
  const hasTrade = qatarAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
