import { mongoliaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/83_mongolia";

export const mongoliaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mongoliaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
