import { kirgizstanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/74_kirgizstan";

export const kirgizstanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kirgizstanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
