import { armeniaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/56_armenia";

export const armeniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = armeniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
