import { yamanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/101_yaman";

export const yamanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = yamanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
