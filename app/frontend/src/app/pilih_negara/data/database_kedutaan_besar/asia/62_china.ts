import { chinaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/62_china";

export const chinaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = chinaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
