import { taiwanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/94_taiwan";

export const taiwanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = taiwanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
