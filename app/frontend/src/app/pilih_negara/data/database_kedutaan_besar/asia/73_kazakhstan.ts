import { kazakhstanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/73_kazakhstan";

export const kazakhstanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kazakhstanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
