import { indiaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/66_india";

export const indiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = indiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
