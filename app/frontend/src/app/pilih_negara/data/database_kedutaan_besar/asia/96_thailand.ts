import { thailandAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/96_thailand";

export const thailandEmbassyConfig = (playerCountry: string) => {
  const hasTrade = thailandAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
