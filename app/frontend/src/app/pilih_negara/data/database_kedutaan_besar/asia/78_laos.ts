import { laosAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/78_laos";

export const laosEmbassyConfig = (playerCountry: string) => {
  const hasTrade = laosAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
