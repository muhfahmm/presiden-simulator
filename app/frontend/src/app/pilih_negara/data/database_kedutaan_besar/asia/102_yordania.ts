import { yordaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/102_yordania";

export const yordaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = yordaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
