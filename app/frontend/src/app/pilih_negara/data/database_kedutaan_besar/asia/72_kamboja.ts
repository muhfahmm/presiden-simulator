import { kambojaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/72_kamboja";

export const kambojaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kambojaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
