import { turkmenistanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/97_turkmenistan";

export const turkmenistanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = turkmenistanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
