import { bhutanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/60_bhutan";

export const bhutanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bhutanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
