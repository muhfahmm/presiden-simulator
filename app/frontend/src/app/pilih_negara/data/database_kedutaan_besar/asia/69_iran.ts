import { iranAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/69_iran";

export const iranEmbassyConfig = (playerCountry: string) => {
  const hasTrade = iranAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
