import { vietnamAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/100_vietnam";

export const vietnamEmbassyConfig = (playerCountry: string) => {
  const hasTrade = vietnamAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
