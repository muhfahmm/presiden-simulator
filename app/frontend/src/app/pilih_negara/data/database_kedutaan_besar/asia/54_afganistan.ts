import { afganistanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/54_afganistan";

export const afganistanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = afganistanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
