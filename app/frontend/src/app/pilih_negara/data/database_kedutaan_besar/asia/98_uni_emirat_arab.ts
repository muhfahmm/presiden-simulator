import { uni_emirat_arabAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/98_uni_emirat_arab";

export const uni_emirat_arabEmbassyConfig = (playerCountry: string) => {
  const hasTrade = uni_emirat_arabAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
