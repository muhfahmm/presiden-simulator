import { lebanonAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/79_lebanon";

export const lebanonEmbassyConfig = (playerCountry: string) => {
  const hasTrade = lebanonAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
