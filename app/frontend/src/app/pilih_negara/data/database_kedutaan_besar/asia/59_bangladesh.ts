import { bangladeshAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/59_bangladesh";

export const bangladeshEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bangladeshAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
