import { tajikistanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/95_tajikistan";

export const tajikistanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tajikistanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
