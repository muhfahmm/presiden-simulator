import { pakistanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/87_pakistan";

export const pakistanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = pakistanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
