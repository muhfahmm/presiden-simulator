import { denmarkAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/112_denmark";

export const denmarkEmbassyConfig = (playerCountry: string) => {
  const hasTrade = denmarkAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
