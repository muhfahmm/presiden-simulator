import { lithuaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/127_lithuania";

export const lithuaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = lithuaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
