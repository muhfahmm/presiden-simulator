import { irlandiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/118_irlandia";

export const irlandiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = irlandiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
