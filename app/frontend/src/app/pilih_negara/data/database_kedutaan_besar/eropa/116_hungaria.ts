import { hungariaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/116_hungaria";

export const hungariaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = hungariaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
