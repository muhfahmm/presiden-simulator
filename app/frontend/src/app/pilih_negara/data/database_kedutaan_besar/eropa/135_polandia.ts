import { polandiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/135_polandia";

export const polandiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = polandiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
