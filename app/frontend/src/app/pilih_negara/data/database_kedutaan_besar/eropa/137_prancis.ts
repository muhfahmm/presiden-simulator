import { prancisAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/137_prancis";

export const prancisEmbassyConfig = (playerCountry: string) => {
  const hasTrade = prancisAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
