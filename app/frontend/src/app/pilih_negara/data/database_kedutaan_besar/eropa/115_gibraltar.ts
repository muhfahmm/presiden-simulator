import { gibraltarAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/115_gibraltar";

export const gibraltarEmbassyConfig = (playerCountry: string) => {
  const hasTrade = gibraltarAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
