import { luksemburgAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/128_luksemburg";

export const luksemburgEmbassyConfig = (playerCountry: string) => {
  const hasTrade = luksemburgAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
