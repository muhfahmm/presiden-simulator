import { belarusAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/107_belarus";

export const belarusEmbassyConfig = (playerCountry: string) => {
  const hasTrade = belarusAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
