import { republik_serbiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/139_republik_serbia";

export const republik_serbiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_serbiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
