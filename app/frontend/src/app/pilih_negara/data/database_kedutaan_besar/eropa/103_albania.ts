import { albaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/103_albania";

export const albaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = albaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
