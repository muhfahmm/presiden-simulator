import { kroasiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/124_kroasia";

export const kroasiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kroasiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
