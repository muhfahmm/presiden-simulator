import { jermanAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/121_jerman";

export const jermanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = jermanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
