import { rusiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/140_rusia";

export const rusiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = rusiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
