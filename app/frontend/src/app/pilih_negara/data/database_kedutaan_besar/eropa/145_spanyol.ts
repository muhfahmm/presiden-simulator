import { spanyolAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/145_spanyol";

export const spanyolEmbassyConfig = (playerCountry: string) => {
  const hasTrade = spanyolAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
