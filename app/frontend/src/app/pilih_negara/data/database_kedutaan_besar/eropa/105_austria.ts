import { austriaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/105_austria";

export const austriaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = austriaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
