import { andorraAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/104_andorra";

export const andorraEmbassyConfig = (playerCountry: string) => {
  const hasTrade = andorraAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
