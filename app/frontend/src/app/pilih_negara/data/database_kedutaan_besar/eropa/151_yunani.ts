import { yunaniAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/151_yunani";

export const yunaniEmbassyConfig = (playerCountry: string) => {
  const hasTrade = yunaniAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
