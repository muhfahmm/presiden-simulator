import { finlandiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/114_finlandia";

export const finlandiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = finlandiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
