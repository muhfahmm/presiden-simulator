import { cekoAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/111_ceko";

export const cekoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = cekoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
