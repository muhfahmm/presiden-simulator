import { kosovoAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/123_kosovo";

export const kosovoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kosovoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
