import { selandia_baruAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/190_selandia_baru";

export const selandia_baruEmbassyConfig = (playerCountry: string) => {
  const hasTrade = selandia_baruAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
