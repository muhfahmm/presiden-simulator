import { samoaAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/188_samoa";

export const samoaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = samoaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
