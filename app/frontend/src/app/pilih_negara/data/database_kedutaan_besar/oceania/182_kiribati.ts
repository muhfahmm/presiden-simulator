import { kiribatiAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/182_kiribati";

export const kiribatiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kiribatiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
