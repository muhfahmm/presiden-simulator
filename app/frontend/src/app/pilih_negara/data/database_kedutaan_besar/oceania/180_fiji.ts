import { fijiAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/180_fiji";

export const fijiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = fijiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
