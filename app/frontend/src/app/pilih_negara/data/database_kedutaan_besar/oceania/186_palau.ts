import { palauAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/186_palau";

export const palauEmbassyConfig = (playerCountry: string) => {
  const hasTrade = palauAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
