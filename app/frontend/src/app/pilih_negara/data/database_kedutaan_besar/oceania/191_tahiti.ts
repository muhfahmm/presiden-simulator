import { tahitiAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/191_tahiti";

export const tahitiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tahitiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
