import { papua_nuginiAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/187_papua_nugini";

export const papua_nuginiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = papua_nuginiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
