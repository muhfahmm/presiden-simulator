import { samoa_amerikaAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/189_samoa_amerika";

export const samoa_amerikaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = samoa_amerikaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
