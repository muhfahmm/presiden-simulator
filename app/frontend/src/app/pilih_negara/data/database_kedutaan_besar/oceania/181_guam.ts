import { guamAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/181_guam";

export const guamEmbassyConfig = (playerCountry: string) => {
  const hasTrade = guamAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
