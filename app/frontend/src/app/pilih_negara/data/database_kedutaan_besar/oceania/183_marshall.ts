import { marshallAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/183_marshall";

export const marshallEmbassyConfig = (playerCountry: string) => {
  const hasTrade = marshallAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
