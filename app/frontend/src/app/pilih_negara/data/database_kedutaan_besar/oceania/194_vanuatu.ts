import { vanuatuAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/194_vanuatu";

export const vanuatuEmbassyConfig = (playerCountry: string) => {
  const hasTrade = vanuatuAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
