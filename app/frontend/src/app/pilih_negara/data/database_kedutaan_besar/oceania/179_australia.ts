import { australiaAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/179_australia";

export const australiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = australiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
