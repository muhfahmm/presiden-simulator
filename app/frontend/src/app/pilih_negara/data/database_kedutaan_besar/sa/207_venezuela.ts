import { venezuelaAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/207_venezuela";

export const venezuelaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = venezuelaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
