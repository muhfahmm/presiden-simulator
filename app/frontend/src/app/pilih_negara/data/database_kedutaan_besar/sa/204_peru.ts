import { peruAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/204_peru";

export const peruEmbassyConfig = (playerCountry: string) => {
  const hasTrade = peruAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
