import { surinameAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/205_suriname";

export const surinameEmbassyConfig = (playerCountry: string) => {
  const hasTrade = surinameAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
