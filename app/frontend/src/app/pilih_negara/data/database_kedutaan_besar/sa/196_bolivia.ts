import { boliviaAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/196_bolivia";

export const boliviaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = boliviaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
