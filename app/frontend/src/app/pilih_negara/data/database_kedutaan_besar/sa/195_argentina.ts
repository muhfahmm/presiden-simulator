import { argentinaAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/195_argentina";

export const argentinaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = argentinaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
