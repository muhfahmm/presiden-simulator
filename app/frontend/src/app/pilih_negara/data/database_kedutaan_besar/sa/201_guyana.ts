import { guyanaAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/201_guyana";

export const guyanaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = guyanaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
