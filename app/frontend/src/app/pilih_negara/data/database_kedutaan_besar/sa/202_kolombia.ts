import { kolombiaAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/202_kolombia";

export const kolombiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kolombiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
