import { brazilAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/197_brazil";

export const brazilEmbassyConfig = (playerCountry: string) => {
  const hasTrade = brazilAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
