import { kenyaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/19_kenya";

export const kenyaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kenyaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
