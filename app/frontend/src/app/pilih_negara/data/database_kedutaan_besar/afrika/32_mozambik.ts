import { mozambikAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/32_mozambik";

export const mozambikEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mozambikAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
