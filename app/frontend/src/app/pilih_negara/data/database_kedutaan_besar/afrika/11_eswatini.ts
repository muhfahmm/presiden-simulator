import { eswatiniAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/11_eswatini";

export const eswatiniEmbassyConfig = (playerCountry: string) => {
  const hasTrade = eswatiniAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
