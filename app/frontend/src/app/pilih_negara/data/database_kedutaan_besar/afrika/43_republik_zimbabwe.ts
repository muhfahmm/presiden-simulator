import { republik_zimbabweAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/43_republik_zimbabwe";

export const republik_zimbabweEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_zimbabweAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
