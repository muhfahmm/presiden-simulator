import { tunisiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/53_tunisia";

export const tunisiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tunisiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
