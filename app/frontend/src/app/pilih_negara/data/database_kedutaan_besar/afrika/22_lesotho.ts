import { lesothoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/22_lesotho";

export const lesothoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = lesothoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
