import { republik_ugandaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/41_republik_uganda";

export const republik_ugandaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_ugandaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
