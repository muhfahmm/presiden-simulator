import { guinea_bissauAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/17_guinea_bissau";

export const guinea_bissauEmbassyConfig = (playerCountry: string) => {
  const hasTrade = guinea_bissauAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
