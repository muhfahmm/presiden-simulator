import { burkina_fasoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/6_burkina_faso";

export const burkina_fasoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = burkina_fasoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
