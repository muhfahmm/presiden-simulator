import { kongoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/21_kongo";

export const kongoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kongoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
