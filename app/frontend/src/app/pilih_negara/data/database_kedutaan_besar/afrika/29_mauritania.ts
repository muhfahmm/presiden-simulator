import { mauritaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/29_mauritania";

export const mauritaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mauritaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
