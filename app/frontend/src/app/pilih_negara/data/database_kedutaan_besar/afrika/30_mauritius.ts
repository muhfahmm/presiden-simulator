import { mauritiusAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/30_mauritius";

export const mauritiusEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mauritiusAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
