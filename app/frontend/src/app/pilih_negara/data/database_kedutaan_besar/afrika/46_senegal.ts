import { senegalAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/46_senegal";

export const senegalEmbassyConfig = (playerCountry: string) => {
  const hasTrade = senegalAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
