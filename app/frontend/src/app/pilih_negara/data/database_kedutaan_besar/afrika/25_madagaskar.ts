import { madagaskarAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/25_madagaskar";

export const madagaskarEmbassyConfig = (playerCountry: string) => {
  const hasTrade = madagaskarAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
