import { namibiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/33_namibia";

export const namibiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = namibiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
