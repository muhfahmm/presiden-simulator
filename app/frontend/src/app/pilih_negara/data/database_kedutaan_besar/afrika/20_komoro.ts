import { komoroAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/20_komoro";

export const komoroEmbassyConfig = (playerCountry: string) => {
  const hasTrade = komoroAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
