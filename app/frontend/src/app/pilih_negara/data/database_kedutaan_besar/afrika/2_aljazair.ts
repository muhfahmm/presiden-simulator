import { aljazairAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/2_aljazair";

export const aljazairEmbassyConfig = (playerCountry: string) => {
  const hasTrade = aljazairAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
