import { afrika_selatanAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/1_afrika_selatan";

export const afrika_selatanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = afrika_selatanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
