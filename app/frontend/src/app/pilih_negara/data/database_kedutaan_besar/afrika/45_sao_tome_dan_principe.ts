import { sao_tome_dan_principeAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/45_sao_tome_dan_principe";

export const sao_tome_dan_principeEmbassyConfig = (playerCountry: string) => {
  const hasTrade = sao_tome_dan_principeAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
