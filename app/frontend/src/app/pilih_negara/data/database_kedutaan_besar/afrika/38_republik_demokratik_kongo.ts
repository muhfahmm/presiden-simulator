import { republik_demokratik_kongoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/38_republik_demokratik_kongo";

export const republik_demokratik_kongoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_demokratik_kongoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
