import { libyaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/24_libya";

export const libyaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = libyaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
