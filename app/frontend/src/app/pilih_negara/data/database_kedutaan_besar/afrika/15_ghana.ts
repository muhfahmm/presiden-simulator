import { ghanaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/15_ghana";

export const ghanaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = ghanaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
