import { togoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/52_togo";

export const togoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = togoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
