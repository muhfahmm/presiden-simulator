import { republik_zambiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/42_republik_zambia";

export const republik_zambiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_zambiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
