import { seychellesAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/47_seychelles";

export const seychellesEmbassyConfig = (playerCountry: string) => {
  const hasTrade = seychellesAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
