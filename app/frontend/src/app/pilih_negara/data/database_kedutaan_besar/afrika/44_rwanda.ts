import { rwandaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/44_rwanda";

export const rwandaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = rwandaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
