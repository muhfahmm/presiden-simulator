import { somaliaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/49_somalia";

export const somaliaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = somaliaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
