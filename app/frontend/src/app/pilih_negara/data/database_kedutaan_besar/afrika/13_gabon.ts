import { gabonAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/13_gabon";

export const gabonEmbassyConfig = (playerCountry: string) => {
  const hasTrade = gabonAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
