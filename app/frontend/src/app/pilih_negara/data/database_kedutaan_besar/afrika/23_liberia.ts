import { liberiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/23_liberia";

export const liberiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = liberiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
