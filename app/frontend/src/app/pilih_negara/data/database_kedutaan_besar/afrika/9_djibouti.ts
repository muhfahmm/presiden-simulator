import { djiboutiAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/9_djibouti";

export const djiboutiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = djiboutiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
