import { mesirAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/31_mesir";

export const mesirEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mesirAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
