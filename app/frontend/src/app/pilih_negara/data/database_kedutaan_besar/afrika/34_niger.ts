import { nigerAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/34_niger";

export const nigerEmbassyConfig = (playerCountry: string) => {
  const hasTrade = nigerAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
