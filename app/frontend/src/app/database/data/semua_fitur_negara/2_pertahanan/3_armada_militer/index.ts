...
export const armadaMiliterList = [
  ...
  { key: "barak", category: "Armada", label: "Barak Militer", deskripsi: "Hunian Tentara", biaya_pembangunan: 40, waktu_pembangunan: 45, biaya_pemeliharaan: 15 },
  { key: "tank", category: "Armada", label: "Main Battle Tank", deskripsi: "Kavaleri Darat", biaya_pembangunan: 20, waktu_pembangunan: 30, biaya_pemeliharaan: 10 },
  { key: "apc", category: "Armada", label: "APC / IFV", deskripsi: "Transportasi Taktis", biaya_pembangunan: 8, waktu_pembangunan: 15, biaya_pemeliharaan: 4 },
  { key: "artileri", category: "Armada", label: "Artileri Berat", deskripsi: "Pukulan Jarak Jauh", biaya_pembangunan: 15, waktu_pembangunan: 45, biaya_pemeliharaan: 8 },
  { key: "rocket", category: "Armada", label: "MLRS Rocket", deskripsi: "Sistem Roket", biaya_pembangunan: 18, waktu_pembangunan: 50, biaya_pemeliharaan: 12 },
  { key: "sam", category: "Armada", label: "Mobile SAM", deskripsi: "Hulu Ledak", biaya_pembangunan: 25, waktu_pembangunan: 60, biaya_pemeliharaan: 15 },
  { key: "tactical", category: "Armada", label: "Kendaraan Taktis", deskripsi: "Patroli Tempur", biaya_pembangunan: 5, waktu_pembangunan: 10, biaya_pemeliharaan: 2 },
  { key: "carrier", category: "Armada", label: "Kapal Induk Konvensional", deskripsi: "Pangkalan Apung", biaya_pembangunan: 750, waktu_pembangunan: 480, biaya_pemeliharaan: 200 },
  { key: "nuclear_carrier", category: "Armada", label: "Kapal Induk Nuklir", deskripsi: "Pangkalan Udara Terapung", biaya_pembangunan: 1500, waktu_pembangunan: 720, biaya_pemeliharaan: 400 },
  { key: "destroyer", category: "Armada", label: "Kapal Destroyer", deskripsi: "Perusak Maritim", biaya_pembangunan: 280, waktu_pembangunan: 360, biaya_pemeliharaan: 100 },
  { key: "corvette", category: "Armada", label: "Kapal Korvet", deskripsi: "Kapal Kawal", biaya_pembangunan: 120, waktu_pembangunan: 180, biaya_pemeliharaan: 45 },
  { key: "submarine", category: "Armada", label: "Kapal Selam Nuklir", deskripsi: "Siluman Bawah Air", biaya_pembangunan: 420, waktu_pembangunan: 420, biaya_pemeliharaan: 150 },
  { key: "reg_sub", category: "Armada", label: "Kapal Selam Reguler", deskripsi: "Selam Reguler", biaya_pembangunan: 150, waktu_pembangunan: 240, biaya_pemeliharaan: 60 },
  { key: "mine_ship", category: "Armada", label: "Kapal Ranjau", deskripsi: "Penyapu Ranjau", biaya_pembangunan: 45, waktu_pembangunan: 90, biaya_pemeliharaan: 15 },
  { key: "logistics", category: "Armada", label: "Kapal Logistik", deskripsi: "Suplai Maritim", biaya_pembangunan: 60, waktu_pembangunan: 120, biaya_pemeliharaan: 25 },
  { key: "stealth_jet", category: "Armada", label: "Jet Stealth", deskripsi: "Supremasi Udara", biaya_pembangunan: 250, waktu_pembangunan: 300, biaya_pemeliharaan: 120 },
  { key: "interceptor", category: "Armada", label: "Jet Interceptor", deskripsi: "Satu Pencegat", biaya_pembangunan: 120, waktu_pembangunan: 180, biaya_pemeliharaan: 55 },
  { key: "bomber", category: "Armada", label: "Pesawat Pengebom", deskripsi: "Serangan Udara", biaya_pembangunan: 350, waktu_pembangunan: 360, biaya_pemeliharaan: 180 },
  { key: "heli_attack", category: "Armada", label: "Heli Serang", deskripsi: "Bantuan Udara", biaya_pembangunan: 40, waktu_pembangunan: 90, biaya_pemeliharaan: 25 },
  { key: "recon_plane", category: "Armada", label: "Pesawat Intai", deskripsi: "Intelijen Udara", biaya_pembangunan: 80, waktu_pembangunan: 120, biaya_pemeliharaan: 20 },
  { key: "uav", category: "Armada", label: "Drone UAV", deskripsi: "Intai Tanpa Awak", biaya_pembangunan: 15, waktu_pembangunan: 30, biaya_pemeliharaan: 5 },
  { key: "kamikaze", category: "Armada", label: "Drone Kamikaze", deskripsi: "Serangan Bunuh Diri", biaya_pembangunan: 5, waktu_pembangunan: 7, biaya_pemeliharaan: 1 },
  { key: "transport", category: "Armada", label: "Pesawat Angkut", deskripsi: "Logistik Udara", biaya_pembangunan: 45, waktu_pembangunan: 90, biaya_pemeliharaan: 15 }
];
