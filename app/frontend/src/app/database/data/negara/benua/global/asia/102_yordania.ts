...
import { yordania_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/102_yordania";
import { yordania_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/102_yordania";
import { yordania_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/102_yordania";
import { yordania_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/102_yordania";
import { yordania_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/102_yordania";
import { yordania_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/102_yordania";
...
import { yordania_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/102_yordania";
import { yordania_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/102_yordania";
import { yordania_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/102_yordania";
...
import { yordania_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/102_yordania";
import { yordania_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/102_yordania";
import { yordania_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/102_yordania";
