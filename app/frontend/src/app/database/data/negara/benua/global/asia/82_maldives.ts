...
import { maldives_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/82_maldives";
import { maldives_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/82_maldives";
import { maldives_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/82_maldives";
import { maldives_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/82_maldives";
import { maldives_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/82_maldives";
import { maldives_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/82_maldives";
...
import { maldives_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/82_maldives";
import { maldives_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/82_maldives";
import { maldives_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/82_maldives";
...
import { maldives_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/82_maldives";
import { maldives_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/82_maldives";
import { maldives_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/82_maldives";
