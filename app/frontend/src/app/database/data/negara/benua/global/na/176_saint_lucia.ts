...
import { saint_lucia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/176_saint_lucia";
import { saint_lucia_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/176_saint_lucia";
import { saint_lucia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/176_saint_lucia";
import { saint_lucia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/176_saint_lucia";
import { saint_lucia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/176_saint_lucia";
import { saint_lucia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/176_saint_lucia";
...
import { saint_lucia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/176_saint_lucia";
import { saint_lucia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/176_saint_lucia";
import { saint_lucia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/176_saint_lucia";
...
import { saint_lucia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/176_saint_lucia";
import { saint_lucia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/176_saint_lucia";
import { saint_lucia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/176_saint_lucia";
