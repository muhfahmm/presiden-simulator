...
import { estonia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/113_estonia";
import { estonia_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/113_estonia";
import { estonia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/113_estonia";
import { estonia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/113_estonia";
import { estonia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/113_estonia";
import { estonia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/113_estonia";
...
import { estonia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/113_estonia";
import { estonia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/113_estonia";
import { estonia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/113_estonia";
...
import { estonia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/113_estonia";
import { estonia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/113_estonia";
import { estonia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/113_estonia";
