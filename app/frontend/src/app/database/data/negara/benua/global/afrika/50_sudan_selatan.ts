...
import { sudan_selatan_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/afrika/50_sudan_selatan";
...
import { sudan_selatan_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/afrika/50_sudan_selatan";
...
import { sudan_selatan_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/afrika/50_sudan_selatan";
import { sudan_selatan_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/afrika/50_sudan_selatan";
...
import { sudan_selatan_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/afrika/50_sudan_selatan";
import { sudan_selatan_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/afrika/50_sudan_selatan";
import { sudan_selatan_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/afrika/50_sudan_selatan";
...
import { sudan_selatan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/afrika/50_sudan_selatan";
...
import { sudan_selatan_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/afrika/50_sudan_selatan";
