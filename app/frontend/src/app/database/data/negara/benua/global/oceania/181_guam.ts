...
import { guam_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/181_guam";
import { guam_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/oceania/181_guam";
import { guam_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/181_guam";
import { guam_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/181_guam";
import { guam_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/181_guam";
import { guam_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/181_guam";
...
import { guam_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/181_guam";
import { guam_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/181_guam";
import { guam_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/181_guam";
...
import { guam_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/181_guam";
import { guam_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/oceania/181_guam";
import { guam_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/181_guam";
