...
import { albania_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/103_albania";
import { albania_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/103_albania";
import { albania_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/103_albania";
import { albania_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/103_albania";
import { albania_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/103_albania";
import { albania_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/103_albania";
...
import { albania_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/103_albania";
import { albania_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/103_albania";
import { albania_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/103_albania";
...
import { albania_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/103_albania";
import { albania_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/103_albania";
import { albania_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/103_albania";
