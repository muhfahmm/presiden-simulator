...
import { venezuela_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/sa/207_venezuela";
import { venezuela_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/sa/207_venezuela";
import { venezuela_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/sa/207_venezuela";
import { venezuela_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/sa/207_venezuela";
import { venezuela_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/sa/207_venezuela";
import { venezuela_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/sa/207_venezuela";
...
import { venezuela_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/sa/207_venezuela";
import { venezuela_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/sa/207_venezuela";
import { venezuela_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/sa/207_venezuela";
...
import { venezuela_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/sa/207_venezuela";
import { venezuela_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/sa/207_venezuela";
import { venezuela_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/sa/207_venezuela";
