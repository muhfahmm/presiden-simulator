...
import { liberia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/23_liberia";
import { liberia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/23_liberia";
import { liberia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/23_liberia";
...
import { liberia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/23_liberia";
import { liberia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/23_liberia";
import { liberia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/23_liberia";
...
import { liberia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/23_liberia";
import { liberia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/afrika/23_liberia";
import { liberia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/23_liberia";
