...
import { polandia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/135_polandia";
import { polandia_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/135_polandia";
import { polandia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/135_polandia";
import { polandia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/135_polandia";
import { polandia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/135_polandia";
import { polandia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/135_polandia";
...
import { polandia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/135_polandia";
import { polandia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/135_polandia";
import { polandia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/135_polandia";
...
import { polandia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/135_polandia";
import { polandia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/135_polandia";
import { polandia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/135_polandia";
