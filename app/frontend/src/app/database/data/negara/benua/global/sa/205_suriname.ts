...
import { suriname_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/sa/205_suriname";
...
import { suriname_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/sa/205_suriname";
import { suriname_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/sa/205_suriname";
import { suriname_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/sa/205_suriname";
import { suriname_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/sa/205_suriname";
...
import { suriname_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/sa/205_suriname";
import { suriname_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/sa/205_suriname";
import { suriname_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/sa/205_suriname";
import { suriname_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/sa/205_suriname";
import { suriname_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/sa/205_suriname";
...
import { suriname_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/sa/205_suriname";
