...
import { pantai_gading_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/afrika/36_pantai_gading";
import { pantai_gading_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/36_pantai_gading";
import { pantai_gading_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/afrika/36_pantai_gading";
import { pantai_gading_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/afrika/36_pantai_gading";
import { pantai_gading_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/36_pantai_gading";
import { pantai_gading_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/afrika/36_pantai_gading";
...
import { pantai_gading_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/afrika/36_pantai_gading";
import { pantai_gading_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/afrika/36_pantai_gading";
import { pantai_gading_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/afrika/36_pantai_gading";
...
import { pantai_gading_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/afrika/36_pantai_gading";
...
import { pantai_gading_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/afrika/36_pantai_gading";
