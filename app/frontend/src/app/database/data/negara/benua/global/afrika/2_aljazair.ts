...
import { aljazair_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/afrika/2_aljazair";
...
import { aljazair_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/afrika/2_aljazair";
import { aljazair_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/afrika/2_aljazair";
import { aljazair_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/afrika/2_aljazair";
import { aljazair_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/afrika/2_aljazair";
...
import { aljazair_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/afrika/2_aljazair";
import { aljazair_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/afrika/2_aljazair";
import { aljazair_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/afrika/2_aljazair";
import { aljazair_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/afrika/2_aljazair";
import { aljazair_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/afrika/2_aljazair";
...
import { aljazair_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/afrika/2_aljazair";
