...
import { aljazair_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/2_aljazair";
import { aljazair_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/2_aljazair";
import { aljazair_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/2_aljazair";
import { aljazair_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/2_aljazair";
import { aljazair_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/2_aljazair";
import { aljazair_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/2_aljazair";
...
import { aljazair_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/2_aljazair";
import { aljazair_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/2_aljazair";
import { aljazair_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/2_aljazair";
...
import { aljazair_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/2_aljazair";
import { aljazair_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/afrika/2_aljazair";
import { aljazair_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/2_aljazair";
