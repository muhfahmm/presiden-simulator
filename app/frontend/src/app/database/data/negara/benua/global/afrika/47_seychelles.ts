...
import { seychelles_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/afrika/47_seychelles";
...
import { seychelles_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/afrika/47_seychelles";
...
import { seychelles_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/afrika/47_seychelles";
import { seychelles_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/afrika/47_seychelles";
...
import { seychelles_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/afrika/47_seychelles";
import { seychelles_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/afrika/47_seychelles";
import { seychelles_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/afrika/47_seychelles";
import { seychelles_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/afrika/47_seychelles";
import { seychelles_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/afrika/47_seychelles";
...
import { seychelles_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/afrika/47_seychelles";
