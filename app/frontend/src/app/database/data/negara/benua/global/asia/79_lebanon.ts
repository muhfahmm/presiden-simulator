...
import { lebanon_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/79_lebanon";
import { lebanon_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/79_lebanon";
import { lebanon_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/79_lebanon";
import { lebanon_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/79_lebanon";
import { lebanon_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/79_lebanon";
import { lebanon_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/79_lebanon";
...
import { lebanon_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/79_lebanon";
import { lebanon_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/79_lebanon";
import { lebanon_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/79_lebanon";
...
import { lebanon_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/79_lebanon";
import { lebanon_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/79_lebanon";
import { lebanon_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/79_lebanon";
