...
import { lebanon_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/79_lebanon";
...
import { lebanon_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/79_lebanon";
import { lebanon_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/79_lebanon";
import { lebanon_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/79_lebanon";
import { lebanon_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/79_lebanon";
...
import { lebanon_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/79_lebanon";
import { lebanon_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/79_lebanon";
import { lebanon_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/79_lebanon";
import { lebanon_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/79_lebanon";
import { lebanon_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/79_lebanon";
...
import { lebanon_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/79_lebanon";
