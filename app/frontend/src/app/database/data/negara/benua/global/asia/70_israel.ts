...
import { israel_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/70_israel";
...
import { israel_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/70_israel";
import { israel_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/70_israel";
import { israel_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/70_israel";
import { israel_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/70_israel";
...
import { israel_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/70_israel";
import { israel_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/70_israel";
import { israel_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/70_israel";
import { israel_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/70_israel";
import { israel_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/70_israel";
...
import { israel_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/70_israel";
