...
import { israel_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/70_israel";
import { israel_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/70_israel";
import { israel_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/70_israel";
import { israel_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/70_israel";
import { israel_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/70_israel";
import { israel_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/70_israel";
...
import { israel_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/70_israel";
import { israel_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/70_israel";
import { israel_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/70_israel";
...
import { israel_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/70_israel";
import { israel_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/70_israel";
import { israel_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/70_israel";
