...
import { samoa_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/188_samoa";
import { samoa_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/oceania/188_samoa";
import { samoa_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/188_samoa";
import { samoa_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/188_samoa";
import { samoa_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/188_samoa";
import { samoa_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/188_samoa";
...
import { samoa_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/188_samoa";
import { samoa_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/188_samoa";
import { samoa_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/188_samoa";
...
import { samoa_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/188_samoa";
import { samoa_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/oceania/188_samoa";
import { samoa_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/188_samoa";
