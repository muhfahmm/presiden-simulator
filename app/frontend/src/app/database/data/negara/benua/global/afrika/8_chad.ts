...
import { chad_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/8_chad";
import { chad_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/8_chad";
import { chad_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/8_chad";
import { chad_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/8_chad";
import { chad_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/8_chad";
import { chad_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/8_chad";
...
import { chad_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/8_chad";
import { chad_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/8_chad";
import { chad_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/8_chad";
...
import { chad_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/8_chad";
import { chad_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/afrika/8_chad";
import { chad_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/8_chad";
