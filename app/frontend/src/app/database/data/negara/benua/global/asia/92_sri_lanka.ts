...
import { sri_lanka_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/92_sri_lanka";
import { sri_lanka_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/92_sri_lanka";
import { sri_lanka_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/92_sri_lanka";
import { sri_lanka_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/92_sri_lanka";
import { sri_lanka_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/92_sri_lanka";
import { sri_lanka_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/92_sri_lanka";
...
import { sri_lanka_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/92_sri_lanka";
import { sri_lanka_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/92_sri_lanka";
import { sri_lanka_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/92_sri_lanka";
...
import { sri_lanka_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/92_sri_lanka";
import { sri_lanka_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/92_sri_lanka";
import { sri_lanka_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/92_sri_lanka";
