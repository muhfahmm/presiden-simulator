...
import { costa_rica_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/158_costa_rica";
import { costa_rica_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/158_costa_rica";
import { costa_rica_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/158_costa_rica";
import { costa_rica_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/158_costa_rica";
import { costa_rica_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/158_costa_rica";
import { costa_rica_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/158_costa_rica";
...
import { costa_rica_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/158_costa_rica";
import { costa_rica_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/158_costa_rica";
import { costa_rica_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/158_costa_rica";
...
import { costa_rica_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/158_costa_rica";
import { costa_rica_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/158_costa_rica";
import { costa_rica_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/158_costa_rica";
