...
import { afrika_selatan_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/1_afrika_selatan";
import { afrika_selatan_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/1_afrika_selatan";
import { afrika_selatan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/1_afrika_selatan";
...
import { afrika_selatan_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/1_afrika_selatan";
...
import { afrika_selatan_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/1_afrika_selatan";
