...
import { tanjung_verde_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/afrika/51_tanjung_verde";
import { tanjung_verde_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/51_tanjung_verde";
import { tanjung_verde_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/afrika/51_tanjung_verde";
import { tanjung_verde_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/afrika/51_tanjung_verde";
import { tanjung_verde_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/51_tanjung_verde";
import { tanjung_verde_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/afrika/51_tanjung_verde";
...
import { tanjung_verde_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/afrika/51_tanjung_verde";
import { tanjung_verde_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/afrika/51_tanjung_verde";
import { tanjung_verde_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/afrika/51_tanjung_verde";
...
import { tanjung_verde_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/afrika/51_tanjung_verde";
...
import { tanjung_verde_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/afrika/51_tanjung_verde";
