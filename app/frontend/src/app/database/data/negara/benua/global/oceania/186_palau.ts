...
import { palau_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/186_palau";
import { palau_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/oceania/186_palau";
import { palau_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/186_palau";
import { palau_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/186_palau";
import { palau_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/186_palau";
import { palau_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/186_palau";
...
import { palau_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/186_palau";
import { palau_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/186_palau";
import { palau_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/186_palau";
...
import { palau_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/186_palau";
import { palau_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/oceania/186_palau";
import { palau_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/186_palau";
