...
import { guiana_prancis_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/sa/200_guiana_prancis";
import { guiana_prancis_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/sa/200_guiana_prancis";
import { guiana_prancis_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/sa/200_guiana_prancis";
import { guiana_prancis_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/sa/200_guiana_prancis";
import { guiana_prancis_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/sa/200_guiana_prancis";
import { guiana_prancis_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/sa/200_guiana_prancis";
...
import { guiana_prancis_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/sa/200_guiana_prancis";
import { guiana_prancis_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/sa/200_guiana_prancis";
import { guiana_prancis_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/sa/200_guiana_prancis";
...
import { guiana_prancis_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/sa/200_guiana_prancis";
...
import { guiana_prancis_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/sa/200_guiana_prancis";
