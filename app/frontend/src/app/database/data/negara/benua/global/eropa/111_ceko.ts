...
import { ceko_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/111_ceko";
import { ceko_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/111_ceko";
import { ceko_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/111_ceko";
import { ceko_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/111_ceko";
import { ceko_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/111_ceko";
import { ceko_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/111_ceko";
...
import { ceko_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/111_ceko";
import { ceko_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/111_ceko";
import { ceko_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/111_ceko";
...
import { ceko_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/111_ceko";
import { ceko_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/111_ceko";
import { ceko_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/111_ceko";
