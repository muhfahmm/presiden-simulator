...
import { belize_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/na/156_belize";
...
import { belize_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/na/156_belize";
import { belize_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/na/156_belize";
import { belize_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/na/156_belize";
import { belize_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/na/156_belize";
...
import { belize_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/na/156_belize";
import { belize_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/na/156_belize";
import { belize_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/na/156_belize";
import { belize_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/na/156_belize";
import { belize_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/na/156_belize";
...
import { belize_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/na/156_belize";
