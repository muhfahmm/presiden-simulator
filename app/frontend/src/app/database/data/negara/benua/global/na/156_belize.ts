...
import { belize_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/156_belize";
import { belize_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/156_belize";
import { belize_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/156_belize";
import { belize_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/156_belize";
import { belize_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/156_belize";
import { belize_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/156_belize";
...
import { belize_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/156_belize";
import { belize_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/156_belize";
import { belize_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/156_belize";
...
import { belize_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/156_belize";
import { belize_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/156_belize";
import { belize_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/156_belize";
