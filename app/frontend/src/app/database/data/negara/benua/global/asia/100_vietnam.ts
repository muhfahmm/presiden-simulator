...
import { vietnam_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/100_vietnam";
...
import { vietnam_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/100_vietnam";
import { vietnam_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/100_vietnam";
import { vietnam_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/100_vietnam";
import { vietnam_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/100_vietnam";
...
import { vietnam_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/100_vietnam";
import { vietnam_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/100_vietnam";
import { vietnam_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/100_vietnam";
import { vietnam_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/100_vietnam";
import { vietnam_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/100_vietnam";
...
import { vietnam_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/100_vietnam";
