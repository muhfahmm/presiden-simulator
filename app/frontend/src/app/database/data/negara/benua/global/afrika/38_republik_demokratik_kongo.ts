...
import { republik_demokratik_kongo_armada } from "@/app/database/data/semua_fitur_negara/4_pertahanan/2_armada_militer/afrika/38_republik_demokratik_kongo";
...
import { republik_demokratik_kongo_kepolisian } from "@/app/database/data/semua_fitur_negara/4_pertahanan/4_armada_kepolisian/afrika/38_republik_demokratik_kongo";
...
import { republik_demokratik_kongo_pertahanan } from "@/app/database/data/semua_fitur_negara/4_pertahanan/1_manajemen_pertahanan/1_sektor_pertahanan/afrika/38_republik_demokratik_kongo";
...
import { republik_demokratik_kongo_strategis } from "@/app/database/data/semua_fitur_negara/4_pertahanan/3_militer_strategis/afrika/38_republik_demokratik_kongo";
