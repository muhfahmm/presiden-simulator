...
import { nauru_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/185_nauru";
import { nauru_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/oceania/185_nauru";
import { nauru_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/185_nauru";
import { nauru_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/185_nauru";
import { nauru_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/185_nauru";
import { nauru_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/185_nauru";
...
import { nauru_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/185_nauru";
import { nauru_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/185_nauru";
import { nauru_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/185_nauru";
...
import { nauru_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/185_nauru";
import { nauru_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/oceania/185_nauru";
import { nauru_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/185_nauru";
