...
import { republik_dominika_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/na/174_republik_dominika";
...
import { republik_dominika_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/na/174_republik_dominika";
import { republik_dominika_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/na/174_republik_dominika";
import { republik_dominika_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/174_republik_dominika";
import { republik_dominika_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/na/174_republik_dominika";
...
import { republik_dominika_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/na/174_republik_dominika";
import { republik_dominika_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/na/174_republik_dominika";
import { republik_dominika_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/na/174_republik_dominika";
...
import { republik_dominika_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/na/174_republik_dominika";
...
import { republik_dominika_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/na/174_republik_dominika";
