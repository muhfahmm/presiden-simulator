...
import { montenegro_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/eropa/133_montenegro";
...
import { montenegro_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/eropa/133_montenegro";
...
import { montenegro_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/eropa/133_montenegro";
import { montenegro_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/eropa/133_montenegro";
...
import { montenegro_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/eropa/133_montenegro";
import { montenegro_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/eropa/133_montenegro";
import { montenegro_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/eropa/133_montenegro";
import { montenegro_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/eropa/133_montenegro";
import { montenegro_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/eropa/133_montenegro";
