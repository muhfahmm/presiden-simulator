...
import { montenegro_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/eropa/133_montenegro";
import { montenegro_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/133_montenegro";
import { montenegro_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/eropa/133_montenegro";
import { montenegro_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/eropa/133_montenegro";
import { montenegro_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/133_montenegro";
import { montenegro_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/eropa/133_montenegro";
...
import { montenegro_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/eropa/133_montenegro";
import { montenegro_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/eropa/133_montenegro";
import { montenegro_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/eropa/133_montenegro";
...
import { montenegro_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/eropa/133_montenegro";
...
import { montenegro_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/eropa/133_montenegro";
