...
import { mozambik_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/32_mozambik";
import { mozambik_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/32_mozambik";
import { mozambik_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/32_mozambik";
import { mozambik_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/32_mozambik";
import { mozambik_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/32_mozambik";
import { mozambik_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/32_mozambik";
...
import { mozambik_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/32_mozambik";
import { mozambik_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/32_mozambik";
import { mozambik_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/32_mozambik";
...
import { mozambik_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/32_mozambik";
import { mozambik_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/afrika/32_mozambik";
import { mozambik_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/32_mozambik";
