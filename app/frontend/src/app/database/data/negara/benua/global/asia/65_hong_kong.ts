...
import { hong_kong_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/65_hong_kong";
...
import { hong_kong_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/65_hong_kong";
import { hong_kong_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/65_hong_kong";
import { hong_kong_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/65_hong_kong";
import { hong_kong_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/65_hong_kong";
...
import { hong_kong_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/65_hong_kong";
import { hong_kong_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/65_hong_kong";
import { hong_kong_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/65_hong_kong";
import { hong_kong_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/65_hong_kong";
import { hong_kong_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/65_hong_kong";
...
import { hong_kong_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/65_hong_kong";
