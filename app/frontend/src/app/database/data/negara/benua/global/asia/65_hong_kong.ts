...
import { hong_kong_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/65_hong_kong";
import { hong_kong_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/65_hong_kong";
import { hong_kong_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/65_hong_kong";
import { hong_kong_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/65_hong_kong";
import { hong_kong_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/65_hong_kong";
import { hong_kong_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/65_hong_kong";
...
import { hong_kong_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/65_hong_kong";
import { hong_kong_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/65_hong_kong";
import { hong_kong_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/65_hong_kong";
...
import { hong_kong_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/65_hong_kong";
import { hong_kong_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/65_hong_kong";
import { hong_kong_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/65_hong_kong";
