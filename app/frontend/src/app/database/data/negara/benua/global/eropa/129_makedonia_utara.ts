...
import { makedonia_utara_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/eropa/129_makedonia_utara";
...
import { makedonia_utara_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/eropa/129_makedonia_utara";
import { makedonia_utara_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/eropa/129_makedonia_utara";
import { makedonia_utara_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/129_makedonia_utara";
import { makedonia_utara_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/eropa/129_makedonia_utara";
...
import { makedonia_utara_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/eropa/129_makedonia_utara";
import { makedonia_utara_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/eropa/129_makedonia_utara";
import { makedonia_utara_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/eropa/129_makedonia_utara";
...
import { makedonia_utara_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/eropa/129_makedonia_utara";
...
import { makedonia_utara_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/eropa/129_makedonia_utara";
