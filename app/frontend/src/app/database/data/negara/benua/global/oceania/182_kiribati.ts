...
import { kiribati_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/182_kiribati";
import { kiribati_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/oceania/182_kiribati";
import { kiribati_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/182_kiribati";
import { kiribati_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/182_kiribati";
import { kiribati_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/182_kiribati";
import { kiribati_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/182_kiribati";
...
import { kiribati_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/182_kiribati";
import { kiribati_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/182_kiribati";
import { kiribati_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/182_kiribati";
...
import { kiribati_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/182_kiribati";
import { kiribati_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/oceania/182_kiribati";
import { kiribati_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/182_kiribati";
