...
import { kiribati_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/oceania/182_kiribati";
...
import { kiribati_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/oceania/182_kiribati";
import { kiribati_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/oceania/182_kiribati";
import { kiribati_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/oceania/182_kiribati";
import { kiribati_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/oceania/182_kiribati";
...
import { kiribati_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/oceania/182_kiribati";
import { kiribati_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/oceania/182_kiribati";
import { kiribati_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/oceania/182_kiribati";
import { kiribati_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/oceania/182_kiribati";
import { kiribati_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/oceania/182_kiribati";
