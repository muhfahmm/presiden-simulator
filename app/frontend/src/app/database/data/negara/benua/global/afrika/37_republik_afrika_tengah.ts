...
import { republik_afrika_tengah_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/37_republik_afrika_tengah";
...
import { republik_afrika_tengah_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/37_republik_afrika_tengah";
import { republik_afrika_tengah_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/37_republik_afrika_tengah";
...
import { republik_afrika_tengah_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/37_republik_afrika_tengah";
...
import { republik_afrika_tengah_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/37_republik_afrika_tengah";
import { republik_afrika_tengah_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/37_republik_afrika_tengah";
import { republik_afrika_tengah_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/37_republik_afrika_tengah";
...
import { republik_afrika_tengah_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/37_republik_afrika_tengah";
...
import { republik_afrika_tengah_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/37_republik_afrika_tengah";
