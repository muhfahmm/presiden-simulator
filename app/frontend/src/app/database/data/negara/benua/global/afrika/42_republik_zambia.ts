...
import { republik_zambia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/42_republik_zambia";
...
import { republik_zambia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/42_republik_zambia";
import { republik_zambia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/42_republik_zambia";
import { republik_zambia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/42_republik_zambia";
import { republik_zambia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/42_republik_zambia";
...
import { republik_zambia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/42_republik_zambia";
import { republik_zambia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/42_republik_zambia";
import { republik_zambia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/42_republik_zambia";
...
import { republik_zambia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/42_republik_zambia";
...
import { republik_zambia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/42_republik_zambia";
