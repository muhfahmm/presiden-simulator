...
import { republik_zambia_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/afrika/42_republik_zambia";
...
import { republik_zambia_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/afrika/42_republik_zambia";
...
import { republik_zambia_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/afrika/42_republik_zambia";
import { republik_zambia_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/afrika/42_republik_zambia";
...
import { republik_zambia_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/afrika/42_republik_zambia";
import { republik_zambia_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/afrika/42_republik_zambia";
import { republik_zambia_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/afrika/42_republik_zambia";
...
import { republik_zambia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/afrika/42_republik_zambia";
...
import { republik_zambia_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/afrika/42_republik_zambia";
