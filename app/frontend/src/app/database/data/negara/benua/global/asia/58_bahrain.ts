...
import { bahrain_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/58_bahrain";
import { bahrain_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/58_bahrain";
import { bahrain_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/58_bahrain";
import { bahrain_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/58_bahrain";
import { bahrain_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/58_bahrain";
import { bahrain_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/58_bahrain";
...
import { bahrain_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/58_bahrain";
import { bahrain_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/58_bahrain";
import { bahrain_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/58_bahrain";
...
import { bahrain_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/58_bahrain";
import { bahrain_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/58_bahrain";
import { bahrain_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/58_bahrain";
