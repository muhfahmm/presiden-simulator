...
import { bahrain_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/58_bahrain";
...
import { bahrain_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/58_bahrain";
import { bahrain_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/58_bahrain";
import { bahrain_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/58_bahrain";
import { bahrain_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/58_bahrain";
...
import { bahrain_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/58_bahrain";
import { bahrain_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/58_bahrain";
import { bahrain_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/58_bahrain";
import { bahrain_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/58_bahrain";
import { bahrain_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/58_bahrain";
...
import { bahrain_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/58_bahrain";
