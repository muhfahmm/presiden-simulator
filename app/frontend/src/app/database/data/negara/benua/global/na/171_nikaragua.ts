...
import { nikaragua_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/171_nikaragua";
import { nikaragua_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/171_nikaragua";
import { nikaragua_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/171_nikaragua";
import { nikaragua_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/171_nikaragua";
import { nikaragua_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/171_nikaragua";
import { nikaragua_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/171_nikaragua";
...
import { nikaragua_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/171_nikaragua";
import { nikaragua_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/171_nikaragua";
import { nikaragua_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/171_nikaragua";
...
import { nikaragua_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/171_nikaragua";
import { nikaragua_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/171_nikaragua";
import { nikaragua_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/171_nikaragua";
