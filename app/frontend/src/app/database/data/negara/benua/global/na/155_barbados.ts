...
import { barbados_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/155_barbados";
import { barbados_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/155_barbados";
import { barbados_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/155_barbados";
import { barbados_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/155_barbados";
import { barbados_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/155_barbados";
import { barbados_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/155_barbados";
...
import { barbados_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/155_barbados";
import { barbados_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/155_barbados";
import { barbados_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/155_barbados";
...
import { barbados_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/155_barbados";
import { barbados_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/155_barbados";
import { barbados_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/155_barbados";
