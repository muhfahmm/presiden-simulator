...
import { botswana_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/afrika/5_botswana";
import { botswana_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/afrika/5_botswana";
import { botswana_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/afrika/5_botswana";
import { botswana_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/afrika/5_botswana";
import { botswana_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/5_botswana";
import { botswana_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/afrika/5_botswana";
...
import { botswana_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/afrika/5_botswana";
import { botswana_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/afrika/5_botswana";
import { botswana_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/afrika/5_botswana";
...
import { botswana_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/afrika/5_botswana";
import { botswana_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/afrika/5_botswana";
import { botswana_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/afrika/5_botswana";
