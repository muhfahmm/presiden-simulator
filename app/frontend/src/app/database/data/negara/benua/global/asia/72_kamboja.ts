...
import { kamboja_armada } from "@/app/database/data/semua_fitur_negara/4_pertahanan/2_armada_militer/asia/72_kamboja";
...
import { kamboja_kepolisian } from "@/app/database/data/semua_fitur_negara/4_pertahanan/4_armada_kepolisian/asia/72_kamboja";
...
import { kamboja_pertahanan } from "@/app/database/data/semua_fitur_negara/4_pertahanan/1_manajemen_pertahanan/1_sektor_pertahanan/asia/72_kamboja";
...
import { kamboja_strategis } from "@/app/database/data/semua_fitur_negara/4_pertahanan/3_militer_strategis/asia/72_kamboja";
