...
import { luksemburg_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/eropa/128_luksemburg";
import { luksemburg_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/128_luksemburg";
import { luksemburg_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/eropa/128_luksemburg";
import { luksemburg_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/eropa/128_luksemburg";
import { luksemburg_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/128_luksemburg";
import { luksemburg_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/eropa/128_luksemburg";
...
import { luksemburg_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/eropa/128_luksemburg";
import { luksemburg_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/eropa/128_luksemburg";
import { luksemburg_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/eropa/128_luksemburg";
...
import { luksemburg_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/eropa/128_luksemburg";
...
import { luksemburg_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/eropa/128_luksemburg";
