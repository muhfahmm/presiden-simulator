...
import { luksemburg_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/eropa/128_luksemburg";
...
import { luksemburg_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/eropa/128_luksemburg";
...
import { luksemburg_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/eropa/128_luksemburg";
import { luksemburg_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/eropa/128_luksemburg";
...
import { luksemburg_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/eropa/128_luksemburg";
import { luksemburg_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/eropa/128_luksemburg";
import { luksemburg_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/eropa/128_luksemburg";
import { luksemburg_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/eropa/128_luksemburg";
import { luksemburg_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/eropa/128_luksemburg";
...
import { luksemburg_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/eropa/128_luksemburg";
