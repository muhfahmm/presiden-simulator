...
import { suriah_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/93_suriah";
import { suriah_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/93_suriah";
import { suriah_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/93_suriah";
import { suriah_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/93_suriah";
import { suriah_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/93_suriah";
import { suriah_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/93_suriah";
...
import { suriah_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/93_suriah";
import { suriah_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/93_suriah";
import { suriah_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/93_suriah";
...
import { suriah_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/93_suriah";
import { suriah_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/93_suriah";
import { suriah_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/93_suriah";
