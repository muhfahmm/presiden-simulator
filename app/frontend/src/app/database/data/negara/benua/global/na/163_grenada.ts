...
import { grenada_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/na/163_grenada";
...
import { grenada_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/na/163_grenada";
import { grenada_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/na/163_grenada";
import { grenada_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/na/163_grenada";
import { grenada_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/na/163_grenada";
...
import { grenada_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/na/163_grenada";
import { grenada_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/na/163_grenada";
import { grenada_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/na/163_grenada";
import { grenada_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/na/163_grenada";
import { grenada_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/na/163_grenada";
...
import { grenada_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/na/163_grenada";
