...
import { grenada_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/163_grenada";
import { grenada_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/163_grenada";
import { grenada_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/163_grenada";
import { grenada_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/163_grenada";
import { grenada_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/163_grenada";
import { grenada_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/163_grenada";
...
import { grenada_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/163_grenada";
import { grenada_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/163_grenada";
import { grenada_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/163_grenada";
...
import { grenada_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/163_grenada";
import { grenada_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/163_grenada";
import { grenada_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/163_grenada";
