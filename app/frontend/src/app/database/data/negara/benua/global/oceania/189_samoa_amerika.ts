...
import { samoa_amerika_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/oceania/189_samoa_amerika";
...
import { samoa_amerika_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/oceania/189_samoa_amerika";
import { samoa_amerika_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/oceania/189_samoa_amerika";
import { samoa_amerika_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/189_samoa_amerika";
import { samoa_amerika_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/oceania/189_samoa_amerika";
...
import { samoa_amerika_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/oceania/189_samoa_amerika";
import { samoa_amerika_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/oceania/189_samoa_amerika";
import { samoa_amerika_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/oceania/189_samoa_amerika";
...
import { samoa_amerika_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/oceania/189_samoa_amerika";
...
import { samoa_amerika_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/oceania/189_samoa_amerika";
