...
import { samoa_amerika_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/oceania/189_samoa_amerika";
...
import { samoa_amerika_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/oceania/189_samoa_amerika";
import { samoa_amerika_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/oceania/189_samoa_amerika";
import { samoa_amerika_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/oceania/189_samoa_amerika";
import { samoa_amerika_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/oceania/189_samoa_amerika";
...
import { samoa_amerika_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/oceania/189_samoa_amerika";
import { samoa_amerika_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/oceania/189_samoa_amerika";
import { samoa_amerika_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/oceania/189_samoa_amerika";
...
import { samoa_amerika_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/oceania/189_samoa_amerika";
...
import { samoa_amerika_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/oceania/189_samoa_amerika";
