...
import { honduras_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/166_honduras";
import { honduras_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/na/166_honduras";
import { honduras_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/166_honduras";
import { honduras_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/166_honduras";
import { honduras_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/166_honduras";
import { honduras_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/166_honduras";
...
import { honduras_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/166_honduras";
import { honduras_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/166_honduras";
import { honduras_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/166_honduras";
...
import { honduras_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/166_honduras";
import { honduras_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/na/166_honduras";
import { honduras_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/166_honduras";
