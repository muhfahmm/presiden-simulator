...
import { honduras_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/na/166_honduras";
...
import { honduras_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/na/166_honduras";
import { honduras_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/na/166_honduras";
import { honduras_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/na/166_honduras";
import { honduras_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/na/166_honduras";
...
import { honduras_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/na/166_honduras";
import { honduras_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/na/166_honduras";
import { honduras_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/na/166_honduras";
import { honduras_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/na/166_honduras";
import { honduras_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/na/166_honduras";
...
import { honduras_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/na/166_honduras";
