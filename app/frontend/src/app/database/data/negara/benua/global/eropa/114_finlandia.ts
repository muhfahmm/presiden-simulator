...
import { finlandia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/114_finlandia";
import { finlandia_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/114_finlandia";
import { finlandia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/114_finlandia";
import { finlandia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/114_finlandia";
import { finlandia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/114_finlandia";
import { finlandia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/114_finlandia";
...
import { finlandia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/114_finlandia";
import { finlandia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/114_finlandia";
import { finlandia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/114_finlandia";
...
import { finlandia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/114_finlandia";
import { finlandia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/114_finlandia";
import { finlandia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/114_finlandia";
