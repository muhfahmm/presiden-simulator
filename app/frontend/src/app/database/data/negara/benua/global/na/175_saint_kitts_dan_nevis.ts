...
import { saint_kitts_dan_nevis_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/na/175_saint_kitts_dan_nevis";
