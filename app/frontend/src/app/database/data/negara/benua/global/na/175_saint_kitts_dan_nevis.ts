...
import { saint_kitts_dan_nevis_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/na/175_saint_kitts_dan_nevis";
import { saint_kitts_dan_nevis_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/na/175_saint_kitts_dan_nevis";
...
import { saint_kitts_dan_nevis_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/na/175_saint_kitts_dan_nevis";
