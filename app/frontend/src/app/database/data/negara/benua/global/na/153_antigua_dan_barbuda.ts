...
import { antigua_dan_barbuda_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/na/153_antigua_dan_barbuda";
