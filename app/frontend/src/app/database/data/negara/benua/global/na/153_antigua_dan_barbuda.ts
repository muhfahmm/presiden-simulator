...
import { antigua_dan_barbuda_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/na/153_antigua_dan_barbuda";
import { antigua_dan_barbuda_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/na/153_antigua_dan_barbuda";
...
import { antigua_dan_barbuda_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/na/153_antigua_dan_barbuda";
