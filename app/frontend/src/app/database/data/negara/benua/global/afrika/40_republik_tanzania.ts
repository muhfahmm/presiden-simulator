...
import { republik_tanzania_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/afrika/40_republik_tanzania";
...
import { republik_tanzania_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/afrika/40_republik_tanzania";
import { republik_tanzania_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/afrika/40_republik_tanzania";
import { republik_tanzania_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/afrika/40_republik_tanzania";
import { republik_tanzania_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/afrika/40_republik_tanzania";
...
import { republik_tanzania_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/afrika/40_republik_tanzania";
import { republik_tanzania_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/afrika/40_republik_tanzania";
import { republik_tanzania_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/afrika/40_republik_tanzania";
...
import { republik_tanzania_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/afrika/40_republik_tanzania";
...
import { republik_tanzania_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/afrika/40_republik_tanzania";
