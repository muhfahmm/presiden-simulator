...
import { kirgizstan_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/74_kirgizstan";
import { kirgizstan_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/74_kirgizstan";
import { kirgizstan_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/74_kirgizstan";
import { kirgizstan_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/74_kirgizstan";
import { kirgizstan_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/74_kirgizstan";
import { kirgizstan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/74_kirgizstan";
...
import { kirgizstan_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/74_kirgizstan";
import { kirgizstan_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/74_kirgizstan";
import { kirgizstan_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/74_kirgizstan";
...
import { kirgizstan_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/74_kirgizstan";
import { kirgizstan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/74_kirgizstan";
import { kirgizstan_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/74_kirgizstan";
