...
import { kirgizstan_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/74_kirgizstan";
...
import { kirgizstan_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/74_kirgizstan";
import { kirgizstan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/74_kirgizstan";
import { kirgizstan_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/74_kirgizstan";
import { kirgizstan_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/74_kirgizstan";
...
import { kirgizstan_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/74_kirgizstan";
import { kirgizstan_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/74_kirgizstan";
import { kirgizstan_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/74_kirgizstan";
import { kirgizstan_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/74_kirgizstan";
import { kirgizstan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/74_kirgizstan";
...
import { kirgizstan_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/asia/74_kirgizstan";
