...
import { kirgizstan_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/asia/74_kirgizstan";
import { kirgizstan_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/74_kirgizstan";
import { kirgizstan_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/asia/74_kirgizstan";
import { kirgizstan_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/asia/74_kirgizstan";
import { kirgizstan_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/74_kirgizstan";
import { kirgizstan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/asia/74_kirgizstan";
...
import { kirgizstan_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/asia/74_kirgizstan";
import { kirgizstan_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/asia/74_kirgizstan";
import { kirgizstan_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/asia/74_kirgizstan";
...
import { kirgizstan_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/asia/74_kirgizstan";
import { kirgizstan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/74_kirgizstan";
import { kirgizstan_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/asia/74_kirgizstan";
