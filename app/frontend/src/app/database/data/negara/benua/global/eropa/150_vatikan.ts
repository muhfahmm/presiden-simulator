...
import { vatikan_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/150_vatikan";
import { vatikan_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/150_vatikan";
import { vatikan_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/150_vatikan";
import { vatikan_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/150_vatikan";
import { vatikan_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/150_vatikan";
import { vatikan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/150_vatikan";
...
import { vatikan_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/150_vatikan";
import { vatikan_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/150_vatikan";
import { vatikan_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/150_vatikan";
...
import { vatikan_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/150_vatikan";
import { vatikan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/150_vatikan";
import { vatikan_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/150_vatikan";
