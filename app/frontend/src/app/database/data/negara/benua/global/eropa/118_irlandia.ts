...
import { irlandia_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/118_irlandia";
import { irlandia_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/118_irlandia";
import { irlandia_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/118_irlandia";
import { irlandia_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/118_irlandia";
import { irlandia_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/118_irlandia";
import { irlandia_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/118_irlandia";
...
import { irlandia_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/118_irlandia";
import { irlandia_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/118_irlandia";
import { irlandia_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/118_irlandia";
...
import { irlandia_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/118_irlandia";
import { irlandia_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/118_irlandia";
import { irlandia_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/118_irlandia";
