...
import { yaman_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/asia/101_yaman";
...
import { yaman_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/asia/101_yaman";
import { yaman_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/9_infrastruktur/asia/101_yaman";
import { yaman_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/asia/101_yaman";
import { yaman_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/asia/101_yaman";
...
import { yaman_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/asia/101_yaman";
import { yaman_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/asia/101_yaman";
import { yaman_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/asia/101_yaman";
import { yaman_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_perikanan/asia/101_yaman";
import { yaman_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/asia/101_yaman";
