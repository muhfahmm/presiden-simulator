...
import { yaman_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/101_yaman";
import { yaman_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/101_yaman";
import { yaman_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/101_yaman";
import { yaman_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/101_yaman";
import { yaman_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/101_yaman";
import { yaman_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/101_yaman";
...
import { yaman_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/101_yaman";
import { yaman_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/101_yaman";
import { yaman_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/101_yaman";
...
import { yaman_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/101_yaman";
import { yaman_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/101_yaman";
import { yaman_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/101_yaman";
