...
import { bhutan_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/asia/60_bhutan";
import { bhutan_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/asia/60_bhutan";
import { bhutan_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/asia/60_bhutan";
import { bhutan_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/asia/60_bhutan";
import { bhutan_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/asia/60_bhutan";
import { bhutan_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/asia/60_bhutan";
...
import { bhutan_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/asia/60_bhutan";
import { bhutan_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/asia/60_bhutan";
import { bhutan_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/asia/60_bhutan";
...
import { bhutan_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/asia/60_bhutan";
import { bhutan_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/asia/60_bhutan";
import { bhutan_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/asia/60_bhutan";
