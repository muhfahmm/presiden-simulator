...
import { republik_rumania_armada } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/2_armada_militer/eropa/138_republik_rumania";
...
import { republik_rumania_hukum } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/3_hukum/eropa/138_republik_rumania";
...
import { republik_rumania_kepolisian } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/4_armada_kepolisian/eropa/138_republik_rumania";
import { republik_rumania_kesehatan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/2_kesehatan/eropa/138_republik_rumania";
...
import { republik_rumania_olahraga } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/4_olahraga/eropa/138_republik_rumania";
import { republik_rumania_pabrik } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/5_pabrik_militer/eropa/138_republik_rumania";
import { republik_rumania_pendidikan } from "@/app/database/data/semua_fitur_negara/3_tempat_umum/1_pendidikan/eropa/138_republik_rumania";
...
import { republik_rumania_pertahanan } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/1_sektor_pertahanan/eropa/138_republik_rumania";
...
import { republik_rumania_strategis } from "@/app/database/data/semua_fitur_negara/2_produksi_militer/3_militer_strategis/eropa/138_republik_rumania";
