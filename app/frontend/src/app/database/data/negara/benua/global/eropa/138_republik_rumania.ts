...
import { republik_rumania_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/138_republik_rumania";
...
import { republik_rumania_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/138_republik_rumania";
import { republik_rumania_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/138_republik_rumania";
import { republik_rumania_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/138_republik_rumania";
import { republik_rumania_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/138_republik_rumania";
...
import { republik_rumania_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/138_republik_rumania";
import { republik_rumania_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/138_republik_rumania";
import { republik_rumania_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/138_republik_rumania";
...
import { republik_rumania_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/138_republik_rumania";
...
import { republik_rumania_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/138_republik_rumania";
