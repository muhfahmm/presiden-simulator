...
import { republik_rumania_agrikultur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/5_sektor_agrikultur/eropa/138_republik_rumania";
...
import { republik_rumania_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/2_sektor_mineral_kritis/eropa/138_republik_rumania";
import { republik_rumania_farmasi } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/8_sektor_farmasi/eropa/138_republik_rumania";
import { republik_rumania_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/138_republik_rumania";
import { republik_rumania_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/9_infrastruktur/eropa/138_republik_rumania";
...
import { republik_rumania_listrik } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/1_sektor_listrik_nasional/eropa/138_republik_rumania";
import { republik_rumania_manufaktur } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/3_manufaktur/eropa/138_republik_rumania";
import { republik_rumania_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/7_sektor_olahan_pangan/eropa/138_republik_rumania";
...
import { republik_rumania_perikanan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/6_sektor_perikanan/eropa/138_republik_rumania";
...
import { republik_rumania_peternakan } from "@/app/database/data/semua_fitur_negara/1_jumlah_bangunan_per_negara/4_sektor_peternakan/eropa/138_republik_rumania";
