...
import { turki_agrikultur } from "@/app/database/data/semua_fitur_negara/1_produksi/7_sektor_agrikultur/eropa/148_turki";
import { turki_armada } from "@/app/database/data/semua_fitur_negara/2_militer/2_armada_militer/eropa/148_turki";
import { turki_ekstraksi } from "@/app/database/data/semua_fitur_negara/1_produksi/4_sektor_ekstraksi/eropa/148_turki";
import { turki_farmasi } from "@/app/database/data/semua_fitur_negara/1_produksi/10_sektor_farmasi/eropa/148_turki";
import { turki_hukum } from "@/app/database/data/semua_fitur_negara/3_sosial/3_hukum/eropa/148_turki";
import { turki_infrastruktur } from "@/app/database/data/semua_fitur_negara/1_produksi/3_infrastruktur/eropa/148_turki";
...
import { turki_listrik } from "@/app/database/data/semua_fitur_negara/1_produksi/2_kelistrikan/eropa/148_turki";
import { turki_manufaktur } from "@/app/database/data/semua_fitur_negara/1_produksi/5_sektor_manufaktur/eropa/148_turki";
import { turki_olahan_pangan } from "@/app/database/data/semua_fitur_negara/1_produksi/9_sektor_olahan_pangan/eropa/148_turki";
...
import { turki_perikanan } from "@/app/database/data/semua_fitur_negara/1_produksi/8_sektor_perikanan/eropa/148_turki";
import { turki_pertahanan } from "@/app/database/data/semua_fitur_negara/2_militer/1_sektor_pertahanan/eropa/148_turki";
import { turki_peternakan } from "@/app/database/data/semua_fitur_negara/1_produksi/6_sektor_peternakan/eropa/148_turki";
