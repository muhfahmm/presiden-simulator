import { bruneiAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/61_brunei";

export const bruneiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bruneiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
