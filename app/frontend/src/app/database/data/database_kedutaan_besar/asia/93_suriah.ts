import { suriahAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/93_suriah";

export const suriahEmbassyConfig = (playerCountry: string) => {
  const hasTrade = suriahAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
