import { makauAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/80_makau";

export const makauEmbassyConfig = (playerCountry: string) => {
  const hasTrade = makauAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
