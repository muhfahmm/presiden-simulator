import { maldivesAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/82_maldives";

export const maldivesEmbassyConfig = (playerCountry: string) => {
  const hasTrade = maldivesAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
