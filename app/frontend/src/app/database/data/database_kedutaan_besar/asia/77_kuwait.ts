import { kuwaitAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/77_kuwait";

export const kuwaitEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kuwaitAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
