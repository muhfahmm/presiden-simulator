import { bahrainAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/58_bahrain";

export const bahrainEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bahrainAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
