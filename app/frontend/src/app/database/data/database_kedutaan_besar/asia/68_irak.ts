import { irakAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/68_irak";

export const irakEmbassyConfig = (playerCountry: string) => {
  const hasTrade = irakAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
