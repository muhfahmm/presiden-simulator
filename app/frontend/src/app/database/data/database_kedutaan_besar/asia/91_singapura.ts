import { singapuraAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/91_singapura";

export const singapuraEmbassyConfig = (playerCountry: string) => {
  const hasTrade = singapuraAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
