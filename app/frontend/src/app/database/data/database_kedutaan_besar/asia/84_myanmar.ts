import { myanmarAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/84_myanmar";

export const myanmarEmbassyConfig = (playerCountry: string) => {
  const hasTrade = myanmarAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
