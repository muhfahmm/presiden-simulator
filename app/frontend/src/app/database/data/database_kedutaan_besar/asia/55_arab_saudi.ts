import { arab_saudiAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/55_arab_saudi";

export const arab_saudiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = arab_saudiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
