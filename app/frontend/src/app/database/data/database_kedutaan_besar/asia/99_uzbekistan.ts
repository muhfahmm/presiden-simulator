import { uzbekistanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/99_uzbekistan";

export const uzbekistanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = uzbekistanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
