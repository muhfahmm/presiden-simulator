import { omanAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/86_oman";

export const omanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = omanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
