import { palestinaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/88_palestina";

export const palestinaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = palestinaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
