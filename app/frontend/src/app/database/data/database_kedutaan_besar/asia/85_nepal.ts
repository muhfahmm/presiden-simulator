import { nepalAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/85_nepal";

export const nepalEmbassyConfig = (playerCountry: string) => {
  const hasTrade = nepalAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
