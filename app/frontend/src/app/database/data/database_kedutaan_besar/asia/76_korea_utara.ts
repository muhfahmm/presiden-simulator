import { korea_utaraAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/76_korea_utara";

export const korea_utaraEmbassyConfig = (playerCountry: string) => {
  const hasTrade = korea_utaraAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
