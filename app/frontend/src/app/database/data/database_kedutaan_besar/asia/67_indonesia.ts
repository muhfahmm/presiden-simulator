import { indonesiaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/67_indonesia";

export const indonesiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = indonesiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
