import { jepangAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/71_jepang";

export const jepangEmbassyConfig = (playerCountry: string) => {
  const hasTrade = jepangAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
