import { filipinaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/63_filipina";

export const filipinaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = filipinaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
