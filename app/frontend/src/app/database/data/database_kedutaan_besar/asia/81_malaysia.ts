import { malaysiaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/81_malaysia";

export const malaysiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = malaysiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
