import { georgiaAgreements } from "@/app/database/data/database_mitra_perdagangan/asia/64_georgia";

export const georgiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = georgiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
