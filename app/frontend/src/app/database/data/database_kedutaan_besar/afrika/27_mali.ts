import { maliAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/27_mali";

export const maliEmbassyConfig = (playerCountry: string) => {
  const hasTrade = maliAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
