import { gambiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/14_gambia";

export const gambiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = gambiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
