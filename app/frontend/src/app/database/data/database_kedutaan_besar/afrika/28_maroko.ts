import { marokoAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/28_maroko";

export const marokoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = marokoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
