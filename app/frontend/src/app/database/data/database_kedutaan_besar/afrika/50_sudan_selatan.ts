import { sudan_selatanAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/50_sudan_selatan";

export const sudan_selatanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = sudan_selatanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
