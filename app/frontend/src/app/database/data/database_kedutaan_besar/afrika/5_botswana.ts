import { botswanaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/5_botswana";

export const botswanaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = botswanaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
