import { malawiAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/26_malawi";

export const malawiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = malawiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
