import { beninAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/4_benin";

export const beninEmbassyConfig = (playerCountry: string) => {
  const hasTrade = beninAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
