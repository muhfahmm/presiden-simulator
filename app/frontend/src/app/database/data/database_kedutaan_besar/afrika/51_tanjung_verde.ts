import { tanjung_verdeAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/51_tanjung_verde";

export const tanjung_verdeEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tanjung_verdeAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
