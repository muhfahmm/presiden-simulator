import { burundiAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/7_burundi";

export const burundiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = burundiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
