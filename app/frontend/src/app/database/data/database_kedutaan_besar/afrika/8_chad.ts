import { chadAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/8_chad";

export const chadEmbassyConfig = (playerCountry: string) => {
  const hasTrade = chadAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
