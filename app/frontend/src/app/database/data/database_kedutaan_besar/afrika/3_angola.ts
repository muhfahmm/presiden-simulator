import { angolaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/3_angola";

export const angolaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = angolaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
