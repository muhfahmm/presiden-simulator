import { ethiopiaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/12_ethiopia";

export const ethiopiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = ethiopiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
