import { eritreaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/10_eritrea";

export const eritreaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = eritreaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
