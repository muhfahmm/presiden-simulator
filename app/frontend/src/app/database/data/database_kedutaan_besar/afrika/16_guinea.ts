import { guineaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/16_guinea";

export const guineaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = guineaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
