import { nigeriaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/35_nigeria";

export const nigeriaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = nigeriaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
