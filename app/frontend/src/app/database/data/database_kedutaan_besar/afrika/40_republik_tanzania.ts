import { republik_tanzaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/40_republik_tanzania";

export const republik_tanzaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_tanzaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
