import { kamerunAgreements } from "@/app/database/data/database_mitra_perdagangan/afrika/18_kamerun";

export const kamerunEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kamerunAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
