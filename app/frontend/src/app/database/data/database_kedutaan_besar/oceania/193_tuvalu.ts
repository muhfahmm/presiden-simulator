import { tuvaluAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/193_tuvalu";

export const tuvaluEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tuvaluAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
