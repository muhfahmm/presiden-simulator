import { nauruAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/185_nauru";

export const nauruEmbassyConfig = (playerCountry: string) => {
  const hasTrade = nauruAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
