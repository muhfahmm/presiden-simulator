import { mikronesiaAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/184_mikronesia";

export const mikronesiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = mikronesiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
