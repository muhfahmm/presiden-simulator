import { tongaAgreements } from "@/app/database/data/database_mitra_perdagangan/oceania/192_tonga";

export const tongaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = tongaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
