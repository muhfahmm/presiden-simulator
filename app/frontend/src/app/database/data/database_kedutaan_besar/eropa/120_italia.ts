import { italiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/120_italia";

export const italiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = italiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
