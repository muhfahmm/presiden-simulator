import { sloveniaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/143_slovenia";

export const sloveniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = sloveniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
