import { norwegiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/134_norwegia";

export const norwegiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = norwegiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
