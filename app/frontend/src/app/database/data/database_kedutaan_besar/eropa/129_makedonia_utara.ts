import { makedonia_utaraAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/129_makedonia_utara";

export const makedonia_utaraEmbassyConfig = (playerCountry: string) => {
  const hasTrade = makedonia_utaraAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
