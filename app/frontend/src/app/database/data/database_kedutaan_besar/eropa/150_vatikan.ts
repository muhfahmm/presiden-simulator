import { vatikanAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/150_vatikan";

export const vatikanEmbassyConfig = (playerCountry: string) => {
  const hasTrade = vatikanAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
