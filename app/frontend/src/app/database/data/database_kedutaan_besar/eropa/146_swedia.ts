import { swediaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/146_swedia";

export const swediaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = swediaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
