import { belandaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/106_belanda";

export const belandaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = belandaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
