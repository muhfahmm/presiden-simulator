import { portugalAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/136_portugal";

export const portugalEmbassyConfig = (playerCountry: string) => {
  const hasTrade = portugalAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
