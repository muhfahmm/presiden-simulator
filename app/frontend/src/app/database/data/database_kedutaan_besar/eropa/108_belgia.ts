import { belgiaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/108_belgia";

export const belgiaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = belgiaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
