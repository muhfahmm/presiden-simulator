import { swissAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/147_swiss";

export const swissEmbassyConfig = (playerCountry: string) => {
  const hasTrade = swissAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
