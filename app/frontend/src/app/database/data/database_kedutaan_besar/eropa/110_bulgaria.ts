import { bulgariaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/110_bulgaria";

export const bulgariaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bulgariaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
