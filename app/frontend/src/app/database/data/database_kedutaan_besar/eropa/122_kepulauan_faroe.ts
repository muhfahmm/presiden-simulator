import { kepulauan_faroeAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/122_kepulauan_faroe";

export const kepulauan_faroeEmbassyConfig = (playerCountry: string) => {
  const hasTrade = kepulauan_faroeAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
