import { estoniaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/113_estonia";

export const estoniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = estoniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
