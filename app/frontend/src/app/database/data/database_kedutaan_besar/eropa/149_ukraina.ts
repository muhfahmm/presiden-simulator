import { ukrainaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/149_ukraina";

export const ukrainaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = ukrainaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
