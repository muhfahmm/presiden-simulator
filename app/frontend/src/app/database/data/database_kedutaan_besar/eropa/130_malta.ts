import { maltaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/130_malta";

export const maltaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = maltaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
