import { moldovaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/131_moldova";

export const moldovaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = moldovaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
