import { siprusAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/142_siprus";

export const siprusEmbassyConfig = (playerCountry: string) => {
  const hasTrade = siprusAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
