import { inggrisAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/117_inggris";

export const inggrisEmbassyConfig = (playerCountry: string) => {
  const hasTrade = inggrisAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
