import { republik_rumaniaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/138_republik_rumania";

export const republik_rumaniaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = republik_rumaniaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
