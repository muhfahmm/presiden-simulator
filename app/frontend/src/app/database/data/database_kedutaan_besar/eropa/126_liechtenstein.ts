import { liechtensteinAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/126_liechtenstein";

export const liechtensteinEmbassyConfig = (playerCountry: string) => {
  const hasTrade = liechtensteinAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
