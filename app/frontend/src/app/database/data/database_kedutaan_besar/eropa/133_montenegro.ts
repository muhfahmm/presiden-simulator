import { montenegroAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/133_montenegro";

export const montenegroEmbassyConfig = (playerCountry: string) => {
  const hasTrade = montenegroAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
