import { san_marinoAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/141_san_marino";

export const san_marinoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = san_marinoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
