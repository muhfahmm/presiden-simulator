import { latviaAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/125_latvia";

export const latviaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = latviaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
