import { turkiAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/148_turki";

export const turkiEmbassyConfig = (playerCountry: string) => {
  const hasTrade = turkiAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
