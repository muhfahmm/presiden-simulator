import { monakoAgreements } from "@/app/database/data/database_mitra_perdagangan/eropa/132_monako";

export const monakoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = monakoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
