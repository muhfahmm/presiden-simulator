import { hondurasAgreements } from "@/app/database/data/database_mitra_perdagangan/na/166_honduras";

export const hondurasEmbassyConfig = (playerCountry: string) => {
  const hasTrade = hondurasAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
