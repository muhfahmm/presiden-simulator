import { dominikaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/160_dominika";

export const dominikaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = dominikaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
