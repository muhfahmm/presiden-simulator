import { saint_kitts_dan_nevisAgreements } from "@/app/database/data/database_mitra_perdagangan/na/175_saint_kitts_dan_nevis";

export const saint_kitts_dan_nevisEmbassyConfig = (playerCountry: string) => {
  const hasTrade = saint_kitts_dan_nevisAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
