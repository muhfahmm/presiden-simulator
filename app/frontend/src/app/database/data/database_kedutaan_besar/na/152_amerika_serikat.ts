import { amerika_serikatAgreements } from "@/app/database/data/database_mitra_perdagangan/na/152_amerika_serikat";

export const amerika_serikatEmbassyConfig = (playerCountry: string) => {
  const hasTrade = amerika_serikatAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
