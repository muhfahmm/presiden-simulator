import { puerto_ricoAgreements } from "@/app/database/data/database_mitra_perdagangan/na/173_puerto_rico";

export const puerto_ricoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = puerto_ricoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
