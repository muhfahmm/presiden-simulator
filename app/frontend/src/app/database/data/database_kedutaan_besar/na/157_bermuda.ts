import { bermudaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/157_bermuda";

export const bermudaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bermudaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
