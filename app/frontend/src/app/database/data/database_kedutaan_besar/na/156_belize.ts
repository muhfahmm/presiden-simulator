import { belizeAgreements } from "@/app/database/data/database_mitra_perdagangan/na/156_belize";

export const belizeEmbassyConfig = (playerCountry: string) => {
  const hasTrade = belizeAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
