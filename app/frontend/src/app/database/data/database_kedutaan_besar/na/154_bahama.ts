import { bahamaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/154_bahama";

export const bahamaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = bahamaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
