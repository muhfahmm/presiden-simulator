import { guatemalaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/164_guatemala";

export const guatemalaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = guatemalaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
