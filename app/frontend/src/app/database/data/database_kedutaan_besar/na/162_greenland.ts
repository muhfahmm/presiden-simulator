import { greenlandAgreements } from "@/app/database/data/database_mitra_perdagangan/na/162_greenland";

export const greenlandEmbassyConfig = (playerCountry: string) => {
  const hasTrade = greenlandAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
