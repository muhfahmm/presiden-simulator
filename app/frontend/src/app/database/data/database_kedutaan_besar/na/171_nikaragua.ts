import { nikaraguaAgreements } from "@/app/database/data/database_mitra_perdagangan/na/171_nikaragua";

export const nikaraguaEmbassyConfig = (playerCountry: string) => {
  const hasTrade = nikaraguaAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
