import { barbadosAgreements } from "@/app/database/data/database_mitra_perdagangan/na/155_barbados";

export const barbadosEmbassyConfig = (playerCountry: string) => {
  const hasTrade = barbadosAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
