import { curacaoAgreements } from "@/app/database/data/database_mitra_perdagangan/na/159_curacao";

export const curacaoEmbassyConfig = (playerCountry: string) => {
  const hasTrade = curacaoAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
