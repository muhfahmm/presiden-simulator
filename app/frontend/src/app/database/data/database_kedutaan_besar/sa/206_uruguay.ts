import { uruguayAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/206_uruguay";

export const uruguayEmbassyConfig = (playerCountry: string) => {
  const hasTrade = uruguayAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
