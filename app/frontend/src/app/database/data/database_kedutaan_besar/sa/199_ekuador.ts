import { ekuadorAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/199_ekuador";

export const ekuadorEmbassyConfig = (playerCountry: string) => {
  const hasTrade = ekuadorAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
