import { paraguayAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/203_paraguay";

export const paraguayEmbassyConfig = (playerCountry: string) => {
  const hasTrade = paraguayAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
