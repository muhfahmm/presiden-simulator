import { chileAgreements } from "@/app/database/data/database_mitra_perdagangan/sa/198_chile";

export const chileEmbassyConfig = (playerCountry: string) => {
  const hasTrade = chileAgreements.some(a => a.mitra === playerCountry && a.status === "Aktif");
  return {
