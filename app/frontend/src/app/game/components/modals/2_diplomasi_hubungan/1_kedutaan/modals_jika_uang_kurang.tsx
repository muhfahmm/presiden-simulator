...
export default function ModalJikaUangKurang({
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center p-4 bg-black/20 animate-in fade-in duration-300">
      <div className="bg-zinc-900/80 backdrop-blur-xl border border-red-500/30 rounded-3xl w-full max-w-md overflow-hidden shadow-[0_0_100px_rgba(239,68,68,0.15)] relative animate-in zoom-in-95 duration-300">
        {/* Warning Accent */}
