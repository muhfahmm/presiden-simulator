        ...
        <div className="flex-1 overflow-y-auto p-10 no-scrollbar space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            ...
            <div className="flex flex-col items-center gap-4 p-8 bg-rose-500/5 border border-rose-500/20 rounded-[32px] relative overflow-hidden group">
              <div className="absolute top-0 left-0 p-4 opacity-10 group-hover:scale-110 transition-transform -scale-x-100 text-rose-500 font-black">
                <Target size={120} />
              </div>
          ...
          {/* Strategic Insight */}
          <div className="p-8 rounded-[3rem] bg-emerald-500/5 border border-emerald-500/20 flex items-center gap-6 text-sans">
