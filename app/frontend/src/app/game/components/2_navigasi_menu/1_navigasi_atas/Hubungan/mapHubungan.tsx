...
import { warMissionStorage, WarMission } from "@/app/game/components/2_navigasi_menu/2_navigasi_bawah/4_pertahanan/1_komando_pertahanan/modals/1_misi_serangan/logic_jalur/warMissionStorage";
    ...
    activeMissions.forEach(mission => {
      ...
      if (curSeg < totalSegs) {
        ...
        mission.unitTypes.forEach((type, idx) => {
          ctx.save();
          ctx.translate(0, (idx - (mission.unitTypes.length - 1) / 2) * 40);
  ...
  return (
    ...
    <canvas
      ...
      onClick={(e) => {
        ...
        if (arrived) {
           window.dispatchEvent(new CustomEvent("war_mode_triggered", { detail: { target: arrived.target } }));
           return;
        }
