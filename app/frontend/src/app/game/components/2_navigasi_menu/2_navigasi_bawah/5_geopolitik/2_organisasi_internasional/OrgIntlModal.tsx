...
const ORGANIZATIONS: Organization[] = [
  ...
  { id: "asean", displayId: "1", name: "ASEAN", desc: "Percepat pertumbuhan ekonomi dan stabilitas politik Asia Tenggara.", focus: "Ekonomi & Keamanan", icon: MapPin, color: "text-rose-500", benefit: "Pasar Regional", impact: "Volume Dagang +15%", category: "REGIONAL", region: "Asia Tenggara" },
  ...
  { id: "arab_league", displayId: "3", name: "Liga Arab", desc: "Kerja sama bangsa Arab di Timur Tengah dan Afrika Utara.", focus: "Budaya & Politik", icon: Users, color: "text-emerald-700", benefit: "Blok Arab", impact: "Solidaritas Politik +30%", category: "REGIONAL", region: "Timur Tengah" },
  ...
  { id: "brics", displayId: "6", name: "BRICS", desc: "Blok ekonomi alternatif untuk menyeimbangkan dominasi barat.", focus: "Ekonomi Alternatif", icon: Coins, color: "text-orange-600", benefit: "Dedolarisasi", impact: "Cadangan Devisa +20%", category: "REGIONAL", region: "Global" },
  { id: "nato", displayId: "7", name: "NATO", desc: "Aliansi pertahanan militer kolektif negara-negara Atlantik Utara.", focus: "Pertahanan Kolektif", icon: Shield, color: "text-indigo-600", benefit: "Payung Nuklir", impact: "Keamanan Kolektif +50%", category: "REGIONAL", region: "Atlantik" },
  { id: "opec", displayId: "8", name: "OPEC", desc: "Kontrol harga energi dan koordinasi kebijakan minyak bumi.", focus: "Harga Energi Dunia", icon: Activity, color: "text-emerald-600", benefit: "Harga Minyak", impact: "Pendapatan Energi +30%", category: "REGIONAL", region: "Global (Minyak)" },
  { id: "g20", displayId: "9", name: "G20", desc: "Forum kerja sama ekonomi internasional antaranegara besar.", focus: "Koordinasi Global", icon: Globe, color: "text-cyan-600", benefit: "Koordinasi Global", impact: "Stabilitas G20 +15%", category: "REGIONAL", region: "Global" },
  { id: "apec", displayId: "10", name: "APEC", desc: "Forum ekonomi Pasifik untuk mempromosikan perdagangan bebas.", focus: "Perdagangan Bebas", icon: TrendingUp, color: "text-blue-500", benefit: "Liberalisasi Dagang", impact: "Arus Dagang +20%", category: "REGIONAL", region: "Asia-Pasifik" },
  { id: "sco", displayId: "11", name: "SCO", desc: "Shanghai Cooperation Organization - Kerja sama keamanan Eurasia.", focus: "Keamanan Eurasia", icon: Shield, color: "text-blue-700", benefit: "Keamanan SCO", impact: "Kontraterorisme +30%", category: "REGIONAL", region: "Eurasia" },
  { id: "oas", displayId: "12", name: "OAS", desc: "Organisasi Negara-Negara Amerika untuk solidaritas regional.", focus: "Demokrasi & HAM", icon: Users, color: "text-blue-400", benefit: "Stabilitas OAS", impact: "Demokrasi +20%", category: "REGIONAL", region: "Amerika" },
  { id: "gcc", displayId: "13", name: "GCC", desc: "Dewan Kerja Sama Teluk untuk integrasi ekonomi negara Arab Teluk.", focus: "Integrasi Teluk", icon: Landmark, color: "text-emerald-600", benefit: "Kemakmuran Pasca-Minyak", impact: "Dana Investasi +40%", category: "REGIONAL", region: "Teluk" },
  { id: "mercosur", displayId: "14", name: "MERCOSUR", desc: "Blok perdagangan dan integrasi ekonomi di Amerika Selatan.", focus: "Blok Dagang Latin", icon: TrendingUp, color: "text-emerald-700", benefit: "Pasar Umum Latin", impact: "Ekon. Amerika Latin +20%", category: "REGIONAL", region: "Amerika Selatan" },
  { id: "commonwealth", displayId: "15", name: "Commonwealth", desc: "Negara Persemakmuran Inggris - Hubungan sejarah & politik.", focus: "Hubungan Politik", icon: Award, color: "text-sky-700", benefit: "Diplomasi Persemakmuran", impact: "Akses Pendidikan UK +25%", category: "REGIONAL", region: "Global" },
  { id: "g7", displayId: "16", name: "G7", desc: "Negara Maju - Kelompok negara dengan pengaruh ekonomi terbesar.", focus: "Ekonomi Global", icon: Briefcase, color: "text-zinc-600", benefit: "Kebijakan Global", impact: "Kebijakan Ekonomi +30%", category: "REGIONAL", region: "Global" },
  { id: "quad", displayId: "17", name: "QUAD", desc: "Aliansi strategis keamanan di wilayah Indo-Pasifik.", focus: "Keamanan Indo-Pac", icon: Shield, color: "text-sky-600", benefit: "Latihan Bersama", impact: "Keamanan Indo-Pasifik +25%", category: "REGIONAL", region: "Indo-Pasifik" },
  { id: "oecd", displayId: "18", name: "OECD", desc: "Standarisasi kebijakan ekonomi dan tata kelola negara maju.", focus: "Standar Kebijakan", icon: Scale, color: "text-cyan-700", benefit: "Standar Global", impact: "Ease of Doing Business +20%", category: "REGIONAL", region: "Maju" }
];
...
export default function OrgIntlModal({ 
  ...
  return (
    <div className="absolute inset-0 bg-black/60 z-50 flex items-center justify-center animate-in fade-in duration-300 p-4 md:p-8 overflow-hidden">
