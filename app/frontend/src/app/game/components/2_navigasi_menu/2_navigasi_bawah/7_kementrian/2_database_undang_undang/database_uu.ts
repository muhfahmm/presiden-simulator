...
export const MOCK_LAWS: Law[] = [
  ...
  // === MILITER & PERTAHANAN ===
  {
    ...
    plus: "Biaya pembangunan Alutsista dalam negeri turun 20%, meningkatkan Nasionalisme warga.",
  ...
  },
  {
    ...
    minus: "Biaya operasional energi yang sangat tinggi, memicu perlombaan senjata regional.",
    status: "Rancangan",
    category: "Militer & Pertahanan",
    icon: Target,
    color: "text-red-500"
  ...
  },
  {
    ...
    minus: "Inovasi teknologi energi terhenti, seluruh biaya ekspansi infrastruktur ditanggung total oleh anggaran negara.",
    status: "Rancangan",
    category: "Energi & Lingkungan",
    icon: Power,
