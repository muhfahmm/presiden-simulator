...
export default function PopulasiModal({ 
  isOpen, 
  onClose,
  activeMenu,
  setActiveMenu
  ...
  const currentTab = activeMenu === "Dashboard:Populasi" ? "statistik" : "overview";
          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 font-medium uppercase tracking-widest mt-1">National Demographics</p>
              </div>
            </div>
