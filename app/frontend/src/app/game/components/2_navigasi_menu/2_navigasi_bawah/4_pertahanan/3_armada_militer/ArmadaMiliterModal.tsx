            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-[40px] shadow-2xl max-w-4xl w-full mx-4 flex flex-col gap-6 animate-in zoom-in-95 max-h-[90vh]">
              ...
              <div className="flex items-center gap-6 shrink-0 border-b border-zinc-800/50 pb-6">
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-zinc-400 text-sm font-medium mt-2">Membangun <span className="text-white font-black underline">{confirmBuild.label}</span> untuk memperkuat armada tempur nasional.</p>
                </div>
              </div>
                        ...
                        {confirmBuild.konsumsi_bahan_bakar > 0 && (
                          <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center gap-1 group">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-xl font-black text-amber-500 tracking-tight">{(confirmBuild.konsumsi_bahan_bakar).toLocaleString('id-ID')} L</span>
                            </div>
                          </div>
                        )}
                        {confirmBuild.konsumsi_uranium > 0 && (
                          <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center gap-1 group col-span-2">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-xl font-black text-emerald-500 tracking-tight">{(confirmBuild.konsumsi_uranium).toLocaleString('id-ID')} KG</span>
                            </div>
                          </div>
                        )}
                      </div>
