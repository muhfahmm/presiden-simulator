...
import {
  ...
  ChevronUp, ArrowRightLeft, Sparkles, BadgePercent, Timer
} from "lucide-react";
...
export default function AiTradeOffersPanel() {
  ...
  const [activeTab, setActiveTab] = useState<"offers" | "requests" | "contracts">("offers");
  ...
  const totalPending = tabCounts.offers + tabCounts.requests + tabCounts.contracts;
