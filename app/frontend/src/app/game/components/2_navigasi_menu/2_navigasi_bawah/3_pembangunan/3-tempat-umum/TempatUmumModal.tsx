  ...
  const publicGroups = [
    {
      ...
      items: [
        ...
        { ...infrastrukturRate["7_bandara"], key: "7_bandara", groupId: "maritim_udara", label: "Bandara", icon: Plane, desc: "Udara", efek: "+0.20% Kepuasan Rakyat & +0.30% Kec. Riset", tarif: 1, unit: "Unit", cost: (infrastrukturRate["7_bandara"].biaya_pembangunan) / 1000, buildTime: infrastrukturRate["7_bandara"].waktu_pembangunan, count: (currentData.infrastruktur?.bandara || 0) + ((buildingDeltas["7_bandara"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.bandara },
        { ...infrastrukturRate["8_helipad"], key: "8_helipad", groupId: "maritim_udara", label: "Helipad", icon: Plane, desc: "Udara", efek: "+0.05% Kepuasan Rakyat & +0.10% Kec. Riset", tarif: 1, unit: "Unit", cost: (infrastrukturRate["8_helipad"].biaya_pembangunan) / 1000, buildTime: infrastrukturRate["8_helipad"].waktu_pembangunan, count: (currentData.infrastruktur?.helipad || 0) + ((buildingDeltas["8_helipad"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.helipad },
      ]
    },
    {
      id: "pendidikan_riset",
      ...
      items: [
        { ...sosialRate["1_prasekolah"], key: "1_prasekolah", groupId: "pendidikan", label: "Prasekolah (PAUD)", icon: Building2, desc: "Pendidikan", efek: "+0.01% Kecepatan Riset Nasional", tarif: 1, cost: (sosialRate["1_prasekolah"].biaya_pembangunan) / 1000, buildTime: sosialRate["1_prasekolah"].waktu_pembangunan, count: (currentData.pendidikan?.prasekolah || 0) + ((buildingDeltas["1_prasekolah"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.prasekolah },
        { ...sosialRate["2_dasar"], key: "2_dasar", groupId: "pendidikan", label: "Pendidikan Dasar", icon: School, desc: "Pendidikan", efek: "+0.03% Kecepatan Riset Nasional", tarif: 1, cost: (sosialRate["2_dasar"].biaya_pembangunan) / 1000, buildTime: sosialRate["2_dasar"].waktu_pembangunan, count: (currentData.pendidikan?.dasar || 0) + ((buildingDeltas["2_dasar"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.dasar },
        { ...sosialRate["3_menengah"], key: "3_menengah", groupId: "pendidikan", label: "Sekolah Menengah", icon: Library, desc: "Pendidikan", efek: "+0.05% Kecepatan Riset Nasional", tarif: 1, cost: (sosialRate["3_menengah"].biaya_pembangunan) / 1000, buildTime: sosialRate["3_menengah"].waktu_pembangunan, count: (currentData.pendidikan?.menengah || 0) + ((buildingDeltas["3_menengah"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.menengah },
    ...
    },
    {
      ...
      color: "text-rose-400",
      items: [
        { ...sosialRate["11_rumah_sakit_besar"], key: "11_rumah_sakit_besar", groupId: "kesehatan", label: "RS Besar", icon: Building2, desc: "Kesehatan", tarif: 1, cost: (sosialRate["11_rumah_sakit_besar"].biaya_pembangunan) / 1000, buildTime: sosialRate["11_rumah_sakit_besar"].waktu_pembangunan, count: (currentData.kesehatan?.rumah_sakit_besar || 0) + ((buildingDeltas["11_rumah_sakit_besar"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.rumah_sakit_besar },
        { ...sosialRate["12_rumah_sakit_kecil"], key: "12_rumah_sakit_kecil", groupId: "kesehatan", label: "RS Kecil", icon: Building2, desc: "Kesehatan", tarif: 1, cost: (sosialRate["12_rumah_sakit_kecil"].biaya_pembangunan) / 1000, buildTime: sosialRate["12_rumah_sakit_kecil"].waktu_pembangunan, count: (currentData.kesehatan?.rumah_sakit_kecil || 0) + ((buildingDeltas["12_rumah_sakit_kecil"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.rumah_sakit_kecil },
        { ...sosialRate["13_pusat_diagnostik"], key: "13_pusat_diagnostik", groupId: "kesehatan", label: "Diagnostik", icon: Search, desc: "Kesehatan", tarif: 1, cost: (sosialRate["13_pusat_diagnostik"].biaya_pembangunan) / 1000, buildTime: sosialRate["13_pusat_diagnostik"].waktu_pembangunan, count: (currentData.kesehatan?.pusat_diagnostik || 0) + ((buildingDeltas["13_pusat_diagnostik"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.pusat_diagnostik },
      ]
    },
    {
      id: "hukum_keamanan",
    ...
    },
    {
      ...
      items: [
        ...
        { ...sosialRate["18_stadium_int"], key: "18_stadium_int", groupId: "olahraga", label: "Stadion (Nas/Int)", icon: Trophy, desc: "Olahraga", tarif: 1, cost: (sosialRate["18_stadium_int"].biaya_pembangunan) / 1000, buildTime: sosialRate["18_stadium_int"].waktu_pembangunan, count: ((currentData.sektor_olahraga?.stadion || 0) + (currentData.sektor_olahraga?.stadion_internasional || 0)) + ((buildingDeltas["18_stadium_int"] as number) || 0), consumption: (KONSUMSI_SOSIAL.olahraga.stadion + KONSUMSI_SOSIAL.olahraga.stadion_internasional) / 2 },
        { ...sosialRate["19_gym_center"], key: "19_gym_center", groupId: "olahraga", label: "Pusat Kebugaran", icon: Dumbbell, desc: "Olahraga", tarif: 1, cost: (sosialRate["19_gym_center"].biaya_pembangunan) / 1000, buildTime: sosialRate["19_gym_center"].waktu_pembangunan, count: (currentData.sektor_olahraga?.gym || 0) + ((buildingDeltas["19_gym_center"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.gym },
        { ...sosialRate["20_lapangan_golf"], key: "20_lapangan_golf", groupId: "olahraga", label: "Lapangan Golf", icon: Flag, desc: "Olahraga", tarif: 1, cost: (sosialRate["20_lapangan_golf"].biaya_pembangunan) / 1000, buildTime: sosialRate["20_lapangan_golf"].waktu_pembangunan, count: (currentData.sektor_olahraga?.golf || 0) + ((buildingDeltas["20_lapangan_golf"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.golf },
        { ...sosialRate["21_esports_arena"], key: "21_esports_arena", groupId: "olahraga", label: "Arena E-Sports", icon: Gamepad2, desc: "Olahraga", tarif: 1, cost: (sosialRate["21_esports_arena"].biaya_pembangunan) / 1000, buildTime: sosialRate["21_esports_arena"].waktu_pembangunan, count: (currentData.sektor_olahraga?.esports || 0) + ((buildingDeltas["21_esports_arena"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.esports },
        { ...sosialRate["22_gokart_circuit"], key: "22_gokart_circuit", groupId: "olahraga", label: "Sirkuit Gokart", icon: Flame, desc: "Olahraga", tarif: 1, cost: (sosialRate["22_gokart_circuit"].biaya_pembangunan) / 1000, buildTime: sosialRate["22_gokart_circuit"].waktu_pembangunan, count: (currentData.sektor_olahraga?.gokart || 0) + ((buildingDeltas["22_gokart_circuit"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.gokart },
      ]
    },
    {
      id: "komersial",
      ...
      items: [
        { ...sosialRate["23_pusat_belanja"], key: "23_pusat_belanja", groupId: "komersial", label: "Pusat Perbelanjaan", icon: Store, desc: "Komersial", tarif: 1, cost: (sosialRate["23_pusat_belanja"].biaya_pembangunan) / 1000, buildTime: sosialRate["23_pusat_belanja"].waktu_pembangunan, count: (currentData.sektor_komersial?.pusat_belanja || 0) + ((buildingDeltas["23_pusat_belanja"] as number) || 0), consumption: KONSUMSI_SOSIAL.komersial.pusat_belanja },
        { ...sosialRate["24_hotel"], key: "24_hotel", groupId: "komersial", label: "Hotel & Resort", icon: Building, desc: "Komersial", tarif: 1, cost: (sosialRate["24_hotel"].biaya_pembangunan) / 1000, buildTime: sosialRate["24_hotel"].waktu_pembangunan, count: (currentData.sektor_komersial?.hotel || 0) + ((buildingDeltas["24_hotel"] as number) || 0), consumption: KONSUMSI_SOSIAL.komersial.hotel },
        { ...sosialRate["25_pusat_grosir_tekstil"], key: "25_pusat_grosir_tekstil", groupId: "komersial", label: "Pusat Grosir", icon: Warehouse, desc: "Komersial", tarif: 1, cost: (sosialRate["25_pusat_grosir_tekstil"].biaya_pembangunan) / 1000, buildTime: sosialRate["25_pusat_grosir_tekstil"].waktu_pembangunan, count: (currentData.sektor_komersial?.pusat_grosir_tekstil || 0) + ((buildingDeltas["25_pusat_grosir_tekstil"] as number) || 0), consumption: KONSUMSI_SOSIAL.komersial.pusat_grosir_tekstil },
      ]
    },
    {
      id: "hiburan",
      ...
      items: [
        { ...sosialRate["26_bioskop"], key: "26_bioskop", groupId: "hiburan", label: "Bioskop", icon: Clapperboard, desc: "Hiburan", tarif: 1, cost: (sosialRate["26_bioskop"].biaya_pembangunan) / 1000, buildTime: sosialRate["26_bioskop"].waktu_pembangunan, count: (currentData.sektor_hiburan?.bioskop || 0) + ((buildingDeltas["26_bioskop"] as number) || 0), consumption: KONSUMSI_SOSIAL.hiburan.bioskop },
        { ...sosialRate["27_gedung_teater"], key: "27_gedung_teater", groupId: "hiburan", label: "Gedung Teater", icon: Theater, desc: "Hiburan", tarif: 1, cost: (sosialRate["27_gedung_teater"].biaya_pembangunan) / 1000, buildTime: sosialRate["27_gedung_teater"].waktu_pembangunan, count: (currentData.sektor_hiburan?.teater || 0) + ((buildingDeltas["27_gedung_teater"] as number) || 0), consumption: KONSUMSI_SOSIAL.hiburan.teater },
      ]
    }
  ];
