  ...
  const publicGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { ...sosialRate["10_kolam_renang"], groupId: "kesehatan", label: "Kolam Renang", icon: Waves, desc: "Olahraga", tarif: 1, cost: sosialRate["10_kolam_renang"].biaya_pembangunan, count: (currentData.sektor_olahraga?.kolam_renang || 0) + ((buildingDeltas["kolam_renang"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.kolam_renang },
        { ...sosialRate["11_sirkuit_balap"], groupId: "kesehatan", label: "Sirkuit Balap", icon: Flame, desc: "Olahraga", tarif: 1, cost: sosialRate["11_sirkuit_balap"].biaya_pembangunan, count: (currentData.sektor_olahraga?.sirkuit_balap || 0) + ((buildingDeltas["sirkuit_balap"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.sirkuit_balap },
        { ...sosialRate["12_stadium_int"], groupId: "kesehatan", label: "Stadion (Nas/Int)", icon: Trophy, desc: "Olahraga", tarif: 1, cost: sosialRate["12_stadium_int"].biaya_pembangunan, count: ((currentData.sektor_olahraga?.stadion || 0) + (currentData.sektor_olahraga?.stadion_internasional || 0)) + ((buildingDeltas["stadium_int"] as number) || 0), consumption: (KONSUMSI_SOSIAL.olahraga.stadion + KONSUMSI_SOSIAL.olahraga.stadion_internasional) / 2 },

        // --- HUKUM & KEAMANAN (6 JENIS) ---
        { ...sosialRate["16_kejaksaan_court"], groupId: "hukum", label: "Kejaksaan/Court", icon: Gavel, desc: "Hukum", tarif: 1, cost: sosialRate["16_kejaksaan_court"].biaya_pembangunan, count: ((currentData.hukum?.kejaksaan || 0) + (currentData.hukum?.pengadilan || 0)) + ((buildingDeltas["kejaksaan_court"] as number) || 0), consumption: (KONSUMSI_SOSIAL.hukum.kejaksaan + KONSUMSI_SOSIAL.hukum.pengadilan) / 2 },
        { ...sosialRate["17_legal_aid"], groupId: "hukum", label: "Bantuan Hukum", icon: Scale, desc: "Hukum", tarif: 1, cost: sosialRate["17_legal_aid"].biaya_pembangunan, count: (currentData.hukum?.pusat_bantuan_hukum || 0) + ((buildingDeltas["legal_aid"] as number) || 0), consumption: KONSUMSI_SOSIAL.hukum.pusat_bantuan_hukum },
      ]
    }
  ];
