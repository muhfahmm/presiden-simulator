  ...
  const publicGroups = [
    {
      ...
      color: "text-cyan-400",
      items: [
        { ...infrastrukturRate["1_jalur_sepeda"], key: "jalur_sepeda", groupId: "infra_darat", label: "Jalur Sepeda", icon: Bike, desc: "Logistik", tarif: 1, unit: "Unit", cost: infrastrukturRate["1_jalur_sepeda"].biaya_pembangunan, buildTime: infrastrukturRate["1_jalur_sepeda"].waktu_pembangunan, maintenanceCost: infrastrukturRate["1_jalur_sepeda"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.jalur_sepeda || 0) + ((buildingDeltas["jalur_sepeda"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.jalur_sepeda },
        { ...infrastrukturRate["2_jalan_tol"], key: "2_jalan_tol", groupId: "infra_darat", label: "Jalan Raya", icon: Map, desc: "Infrastruktur", tarif: 1, unit: "Unit", cost: infrastrukturRate["2_jalan_tol"].biaya_pembangunan, buildTime: infrastrukturRate["2_jalan_tol"].waktu_pembangunan, maintenanceCost: infrastrukturRate["2_jalan_tol"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.jalan_raya || 0) + ((buildingDeltas["2_jalan_tol"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.jalan_raya },
        { ...infrastrukturRate["3_terminal_bus"], key: "terminal_bus", groupId: "infra_darat", label: "Terminal Bus", icon: Bus, desc: "Transportasi", tarif: 1, unit: "Unit", cost: infrastrukturRate["3_terminal_bus"].biaya_pembangunan, buildTime: infrastrukturRate["3_terminal_bus"].waktu_pembangunan, maintenanceCost: infrastrukturRate["3_terminal_bus"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.terminal_bus || 0) + ((buildingDeltas["terminal_bus"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.terminal_bus },
        
        { ...infrastrukturRate["4_jalur_kereta"], key: "4_jalur_kereta", groupId: "perkeretaapian", label: "Stasiun Kereta Api", icon: TrainFront, desc: "Logistik", tarif: 1, unit: "Unit", cost: infrastrukturRate["4_jalur_kereta"].biaya_pembangunan, buildTime: infrastrukturRate["4_jalur_kereta"].waktu_pembangunan, maintenanceCost: infrastrukturRate["4_jalur_kereta"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.stasiun_kereta_api || 0) + ((buildingDeltas["4_jalur_kereta"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.stasiun_kereta_api },
        { ...infrastrukturRate["5_kereta_bawah_tanah"], key: "kereta_bawah_tanah", groupId: "perkeretaapian", label: "Kereta Bawah Tanah", icon: TrainFront, desc: "Transportasi", tarif: 1, unit: "Unit", cost: infrastrukturRate["5_kereta_bawah_tanah"].biaya_pembangunan, buildTime: infrastrukturRate["5_kereta_bawah_tanah"].waktu_pembangunan, maintenanceCost: infrastrukturRate["5_kereta_bawah_tanah"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.kereta_bawah_tanah || 0) + ((buildingDeltas["kereta_bawah_tanah"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.kereta_bawah_tanah },
        
        { ...infrastrukturRate["6_pelabuhan_laut"], key: "6_pelabuhan_laut", groupId: "maritim_udara", label: "Pelabuhan", icon: Ship, desc: "Maritim", tarif: 1, unit: "Unit", cost: infrastrukturRate["6_pelabuhan_laut"].biaya_pembangunan, buildTime: infrastrukturRate["6_pelabuhan_laut"].waktu_pembangunan, maintenanceCost: infrastrukturRate["6_pelabuhan_laut"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.pelabuhan || 0) + ((buildingDeltas["6_pelabuhan_laut"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.pelabuhan },
        { ...infrastrukturRate["7_bandara"], key: "bandara", groupId: "maritim_udara", label: "Bandara", icon: Plane, desc: "Udara", tarif: 1, unit: "Unit", cost: infrastrukturRate["7_bandara"].biaya_pembangunan, buildTime: infrastrukturRate["7_bandara"].waktu_pembangunan, maintenanceCost: infrastrukturRate["7_bandara"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.bandara || 0) + ((buildingDeltas["bandara"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.bandara },
        { ...infrastrukturRate["8_helipad"], key: "helipad", groupId: "maritim_udara", label: "Helipad", icon: Plane, desc: "Udara", tarif: 1, unit: "Unit", cost: infrastrukturRate["8_helipad"].biaya_pembangunan, buildTime: infrastrukturRate["8_helipad"].waktu_pembangunan, maintenanceCost: infrastrukturRate["8_helipad"].biaya_pemeliharaan || 5, count: (currentData.infrastruktur?.helipad || 0) + ((buildingDeltas["helipad"] as number) || 0), consumption: KONSUMSI_TRANSPORTASI.helipad },
      ]
    },
    {
      id: "pendidikan_riset",
      ...
      items: [
        { ...sosialRate["1_prasekolah"], key: "prasekolah", groupId: "pendidikan", label: "Prasekolah (PAUD)", icon: Building2, desc: "Pendidikan", tarif: 1, cost: sosialRate["1_prasekolah"].biaya_pembangunan, buildTime: sosialRate["1_prasekolah"].waktu_pembangunan, maintenanceCost: sosialRate["1_prasekolah"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.prasekolah || 0) + ((buildingDeltas["prasekolah"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.prasekolah },
        { ...sosialRate["2_dasar"], key: "dasar", groupId: "pendidikan", label: "Pendidikan Dasar", icon: School, desc: "Pendidikan", tarif: 1, cost: sosialRate["2_dasar"].biaya_pembangunan, buildTime: sosialRate["2_dasar"].waktu_pembangunan, maintenanceCost: sosialRate["2_dasar"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.dasar || 0) + ((buildingDeltas["dasar"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.dasar },
        { ...sosialRate["3_menengah"], key: "menengah", groupId: "pendidikan", label: "Sekolah Menengah", icon: Library, desc: "Pendidikan", tarif: 1, cost: sosialRate["3_menengah"].biaya_pembangunan, buildTime: sosialRate["3_menengah"].waktu_pembangunan, maintenanceCost: sosialRate["3_menengah"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.menengah || 0) + ((buildingDeltas["menengah"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.menengah },
        { ...sosialRate["4_lanjutan"], key: "lanjutan", groupId: "pendidikan", label: "Sekolah Lanjutan", icon: GraduationCap, desc: "Pendidikan", tarif: 1, cost: sosialRate["4_lanjutan"].biaya_pembangunan, buildTime: sosialRate["4_lanjutan"].waktu_pembangunan, maintenanceCost: sosialRate["4_lanjutan"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.lanjutan || 0) + ((buildingDeltas["lanjutan"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.lanjutan },
        { ...sosialRate["5_universitas"], key: "universitas", groupId: "pendidikan", label: "Universitas", icon: Landmark, desc: "Pendidikan Tinggi", tarif: 1, cost: sosialRate["5_universitas"].biaya_pembangunan, buildTime: sosialRate["5_universitas"].waktu_pembangunan, maintenanceCost: sosialRate["5_universitas"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.universitas || 0) + ((buildingDeltas["universitas"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.universitas },
        { ...sosialRate["6_lembaga_pendidikan"], key: "lembaga_pendidikan", groupId: "pendidikan", label: "Lembaga Pendidikan", icon: Briefcase, desc: "Vokasional", tarif: 1, cost: sosialRate["6_lembaga_pendidikan"].biaya_pembangunan, buildTime: sosialRate["6_lembaga_pendidikan"].waktu_pembangunan, maintenanceCost: sosialRate["6_lembaga_pendidikan"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.lembaga_pendidikan || 0) + ((buildingDeltas["lembaga_pendidikan"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.lembaga_pendidikan },
        { ...sosialRate["7_laboratorium"], key: "laboratorium", groupId: "pendidikan", label: "Laboratorium", icon: Microscope, desc: "Riset", tarif: 1, cost: sosialRate["7_laboratorium"].biaya_pembangunan, buildTime: sosialRate["7_laboratorium"].waktu_pembangunan, maintenanceCost: sosialRate["7_laboratorium"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.laboratorium || 0) + ((buildingDeltas["laboratorium"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.laboratorium },
        { ...sosialRate["8_observatorium"], key: "observatorium", groupId: "pendidikan", label: "Observatorium", icon: Eye, desc: "Astronomi", tarif: 1, cost: sosialRate["8_observatorium"].biaya_pembangunan, buildTime: sosialRate["8_observatorium"].waktu_pembangunan, maintenanceCost: sosialRate["8_observatorium"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.observatorium || 0) + ((buildingDeltas["observatorium"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.observatorium },
        { ...sosialRate["9_pusat_penelitian"], key: "pusat_penelitian", groupId: "pendidikan", label: "Pusat Penelitian", icon: Search, desc: "Riset Strategis", tarif: 1, cost: sosialRate["9_pusat_penelitian"].biaya_pembangunan, buildTime: sosialRate["9_pusat_penelitian"].waktu_pembangunan, maintenanceCost: sosialRate["9_pusat_penelitian"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.pusat_penelitian || 0) + ((buildingDeltas["pusat_penelitian"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.pusat_penelitian },
        { ...sosialRate["10_pusat_pengembangan"], key: "pusat_pengembangan", groupId: "pendidikan", label: "Pusat Pengembangan", icon: Lightbulb, desc: "Inovasi", tarif: 1, cost: sosialRate["10_pusat_pengembangan"].biaya_pembangunan, buildTime: sosialRate["10_pusat_pengembangan"].waktu_pembangunan, maintenanceCost: sosialRate["10_pusat_pengembangan"].biaya_pemeliharaan || 5, count: (currentData.pendidikan?.pusat_pengembangan || 0) + ((buildingDeltas["pusat_pengembangan"] as number) || 0), consumption: KONSUMSI_SOSIAL.pendidikan.pusat_pengembangan },
      ]
    },
    {
      id: "kesehatan",
      ...
      color: "text-rose-400",
      items: [
        { ...sosialRate["11_rumah_sakit_besar"], key: "rumah_sakit_besar", groupId: "kesehatan", label: "RS Besar", icon: Building2, desc: "Kesehatan", tarif: 1, cost: sosialRate["11_rumah_sakit_besar"].biaya_pembangunan, buildTime: sosialRate["11_rumah_sakit_besar"].waktu_pembangunan, maintenanceCost: sosialRate["11_rumah_sakit_besar"].biaya_pemeliharaan || 5, count: (currentData.kesehatan?.rumah_sakit_besar || 0) + ((buildingDeltas["rumah_sakit_besar"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.rumah_sakit_besar },
        { ...sosialRate["12_rumah_sakit_kecil"], key: "rumah_sakit_kecil", groupId: "kesehatan", label: "RS Kecil", icon: Building2, desc: "Kesehatan", tarif: 1, cost: sosialRate["12_rumah_sakit_kecil"].biaya_pembangunan, buildTime: sosialRate["12_rumah_sakit_kecil"].waktu_pembangunan, maintenanceCost: sosialRate["12_rumah_sakit_kecil"].biaya_pemeliharaan || 5, count: (currentData.kesehatan?.rumah_sakit_kecil || 0) + ((buildingDeltas["rumah_sakit_kecil"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.rumah_sakit_kecil },
        { ...sosialRate["13_pusat_diagnostik"], key: "pusat_diagnostik", groupId: "kesehatan", label: "Diagnostik", icon: Search, desc: "Kesehatan", tarif: 1, cost: sosialRate["13_pusat_diagnostik"].biaya_pembangunan, buildTime: sosialRate["13_pusat_diagnostik"].waktu_pembangunan, maintenanceCost: sosialRate["13_pusat_diagnostik"].biaya_pemeliharaan || 5, count: (currentData.kesehatan?.pusat_diagnostik || 0) + ((buildingDeltas["pusat_diagnostik"] as number) || 0), consumption: KONSUMSI_SOSIAL.kesehatan.pusat_diagnostik },
      ]
    },
    {
      id: "hukum_keamanan",
      ...
      items: [
        { ...sosialRate["14_kejaksaan_court"], key: "kejaksaan_court", groupId: "hukum", label: "Kejaksaan / Court", icon: Gavel, desc: "Hukum", tarif: 1, cost: sosialRate["14_kejaksaan_court"].biaya_pembangunan, buildTime: sosialRate["14_kejaksaan_court"].waktu_pembangunan, maintenanceCost: sosialRate["14_kejaksaan_court"].biaya_pemeliharaan || 5, count: ((currentData.hukum?.kejaksaan || 0) + (currentData.hukum?.pengadilan || 0)) + ((buildingDeltas["kejaksaan_court"] as number) || 0), consumption: (KONSUMSI_SOSIAL.hukum.kejaksaan + KONSUMSI_SOSIAL.hukum.pengadilan) / 2 },
        { ...sosialRate["15_legal_aid"], key: "legal_aid", groupId: "hukum", label: "Bantuan Hukum", icon: Scale, desc: "Hukum", tarif: 1, cost: sosialRate["15_legal_aid"].biaya_pembangunan, buildTime: sosialRate["15_legal_aid"].waktu_pembangunan, maintenanceCost: sosialRate["15_legal_aid"].biaya_pemeliharaan || 5, count: (currentData.hukum?.pusat_bantuan_hukum || 0) + ((buildingDeltas["legal_aid"] as number) || 0), consumption: KONSUMSI_SOSIAL.hukum.pusat_bantuan_hukum },
      ]
    },
    {
      id: "olahraga",
      ...
      items: [
        { ...sosialRate["16_kolam_renang"], key: "kolam_renang", groupId: "olahraga", label: "Kolam Renang", icon: Waves, desc: "Olahraga", tarif: 1, cost: sosialRate["16_kolam_renang"].biaya_pembangunan, buildTime: sosialRate["16_kolam_renang"].waktu_pembangunan, maintenanceCost: sosialRate["16_kolam_renang"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.kolam_renang || 0) + ((buildingDeltas["kolam_renang"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.kolam_renang },
        { ...sosialRate["17_sirkuit_balap"], key: "sirkuit_balap", groupId: "olahraga", label: "Sirkuit Balap", icon: Flame, desc: "Olahraga", tarif: 1, cost: sosialRate["17_sirkuit_balap"].biaya_pembangunan, buildTime: sosialRate["17_sirkuit_balap"].waktu_pembangunan, maintenanceCost: sosialRate["17_sirkuit_balap"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.sirkuit_balap || 0) + ((buildingDeltas["sirkuit_balap"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.sirkuit_balap },
        { ...sosialRate["18_stadium_int"], key: "stadium_int", groupId: "olahraga", label: "Stadion (Nas/Int)", icon: Trophy, desc: "Olahraga", tarif: 1, cost: sosialRate["18_stadium_int"].biaya_pembangunan, buildTime: sosialRate["18_stadium_int"].waktu_pembangunan, maintenanceCost: sosialRate["18_stadium_int"].biaya_pemeliharaan || 5, count: ((currentData.sektor_olahraga?.stadion || 0) + (currentData.sektor_olahraga?.stadion_internasional || 0)) + ((buildingDeltas["stadium_int"] as number) || 0), consumption: (KONSUMSI_SOSIAL.olahraga.stadion + KONSUMSI_SOSIAL.olahraga.stadion_internasional) / 2 },
        { ...sosialRate["19_gym_center"], key: "gym_center", groupId: "olahraga", label: "Pusat Kebugaran", icon: Dumbbell, desc: "Olahraga", tarif: 1, cost: sosialRate["19_gym_center"].biaya_pembangunan, buildTime: sosialRate["19_gym_center"].waktu_pembangunan, maintenanceCost: sosialRate["19_gym_center"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.gym || 0) + ((buildingDeltas["gym_center"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.gym },
        { ...sosialRate["20_lapangan_golf"], key: "lapangan_golf", groupId: "olahraga", label: "Lapangan Golf", icon: Flag, desc: "Olahraga", tarif: 1, cost: sosialRate["20_lapangan_golf"].biaya_pembangunan, buildTime: sosialRate["20_lapangan_golf"].waktu_pembangunan, maintenanceCost: sosialRate["20_lapangan_golf"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.golf || 0) + ((buildingDeltas["lapangan_golf"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.golf },
        { ...sosialRate["21_esports_arena"], key: "esports_arena", groupId: "olahraga", label: "Arena E-Sports", icon: Gamepad2, desc: "Olahraga", tarif: 1, cost: sosialRate["21_esports_arena"].biaya_pembangunan, buildTime: sosialRate["21_esports_arena"].waktu_pembangunan, maintenanceCost: sosialRate["21_esports_arena"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.esports || 0) + ((buildingDeltas["esports_arena"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.esports },
        { ...sosialRate["22_gokart_circuit"], key: "gokart_circuit", groupId: "olahraga", label: "Sirkuit Gokart", icon: Flame, desc: "Olahraga", tarif: 1, cost: sosialRate["22_gokart_circuit"].biaya_pembangunan, buildTime: sosialRate["22_gokart_circuit"].waktu_pembangunan, maintenanceCost: sosialRate["22_gokart_circuit"].biaya_pemeliharaan || 5, count: (currentData.sektor_olahraga?.gokart || 0) + ((buildingDeltas["gokart_circuit"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.gokart },
      ]
    },
    {
      id: "hiburan",
      ...
      items: [
        { ...sosialRate["26_bioskop"], key: "bioskop", groupId: "hiburan", label: "Bioskop", icon: Clapperboard, desc: "Hiburan", tarif: 1, cost: sosialRate["26_bioskop"].biaya_pembangunan, buildTime: sosialRate["26_bioskop"].waktu_pembangunan, maintenanceCost: sosialRate["26_bioskop"].biaya_pemeliharaan || 5, count: (currentData.sektor_hiburan?.bioskop || 0) + ((buildingDeltas["bioskop"] as number) || 0), consumption: KONSUMSI_SOSIAL.hiburan.bioskop },
        { ...sosialRate["27_gedung_teater"], key: "gedung_teater", groupId: "hiburan", label: "Gedung Teater", icon: Theater, desc: "Hiburan", tarif: 1, cost: sosialRate["27_gedung_teater"].biaya_pembangunan, buildTime: sosialRate["27_gedung_teater"].waktu_pembangunan, maintenanceCost: sosialRate["27_gedung_teater"].biaya_pemeliharaan || 5, count: (currentData.sektor_hiburan?.teater || 0) + ((buildingDeltas["gedung_teater"] as number) || 0), consumption: KONSUMSI_SOSIAL.hiburan.teater },
      ]
    }
  ];
