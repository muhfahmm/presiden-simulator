  ...
  const policeGroups = [
    {
      ...
      color: "text-blue-500",
      items: [
        { ...armadaPolisiRate["1_pusat_komando"], key: "1_pusat_komando_polisi", groupId: "komando", icon: Shield, biaya_pembangunan: (armadaPolisiRate["1_pusat_komando"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["1_pusat_komando"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["1_pusat_komando"].get_konsumsi_listrik?.() || armadaPolisiRate["1_pusat_komando"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["1_pusat_komando"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.markas_besar_polri || 0) + ((buildingDeltas["markas_besar_polri"] as number) || 0) },
        { ...armadaPolisiRate["2_akademi_polisi"], key: "2_akademi_polisi", groupId: "komando", icon: GraduationCap, biaya_pembangunan: (armadaPolisiRate["2_akademi_polisi"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["2_akademi_polisi"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["2_akademi_polisi"].get_konsumsi_listrik?.() || armadaPolisiRate["2_akademi_polisi"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["2_akademi_polisi"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.akademi_kepolisian || 0) + ((buildingDeltas["akademi_kepolisian"] as number) || 0) },
        { ...armadaPolisiRate["3_pusat_forensik"], key: "3_pusat_forensik", groupId: "komando", icon: Search, biaya_pembangunan: (armadaPolisiRate["3_pusat_forensik"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["3_pusat_forensik"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["3_pusat_forensik"].get_konsumsi_listrik?.() || armadaPolisiRate["3_pusat_forensik"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["3_pusat_forensik"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.pusat_forensik || 0) + ((buildingDeltas["pusat_forensik"] as number) || 0) },
      ]
    },
    {
      id: "unit_pelayanan",
      ...
      items: [
        { ...armadaPolisiRate["4_kantor_polisi"], key: "4_kantor_polisi", groupId: "wilayah", icon: Siren, biaya_pembangunan: (armadaPolisiRate["4_kantor_polisi"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["4_kantor_polisi"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["4_kantor_polisi"].get_konsumsi_listrik?.() || armadaPolisiRate["4_kantor_polisi"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["4_kantor_polisi"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.kantor_polisi || 0) + ((buildingDeltas["kantor_polisi"] as number) || 0) },
        { ...armadaPolisiRate["5_pos_polisi"], key: "5_pos_polisi", groupId: "wilayah", icon: ShieldAlert, biaya_pembangunan: (armadaPolisiRate["5_pos_polisi"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["5_pos_polisi"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["5_pos_polisi"].get_konsumsi_listrik?.() || armadaPolisiRate["5_pos_polisi"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["5_pos_polisi"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.pos_polisi || 0) + ((buildingDeltas["pos_polisi"] as number) || 0) },
        { ...armadaPolisiRate["6_network_cctv"], key: "6_network_cctv", groupId: "wilayah", icon: Cctv, biaya_pembangunan: (armadaPolisiRate["6_network_cctv"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["6_network_cctv"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["6_network_cctv"].get_konsumsi_listrik?.() || armadaPolisiRate["6_network_cctv"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["6_network_cctv"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.network_cctv || 0) + ((buildingDeltas["network_cctv"] as number) || 0) },
      ]
    },
    {
    ...
    },
    {
      ...
      color: "text-rose-500",
      items: [
        { ...armadaPolisiRate["11_unit_k9"], key: "11_unit_k9", groupId: "khusus", icon: Dog, biaya_pembangunan: (armadaPolisiRate["11_unit_k9"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["11_unit_k9"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["11_unit_k9"].get_konsumsi_listrik?.() || armadaPolisiRate["11_unit_k9"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["11_unit_k9"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.unit_k9 || 0) + ((buildingDeltas["unit_k9"] as number) || 0) },
        { ...armadaPolisiRate["12_swat"], key: "12_swat", groupId: "khusus", icon: Crosshair, biaya_pembangunan: (armadaPolisiRate["12_swat"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["12_swat"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["12_swat"].get_konsumsi_listrik?.() || armadaPolisiRate["12_swat"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["12_swat"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.pasukan_swat || 0) + ((buildingDeltas["pasukan_swat"] as number) || 0) },
        { ...armadaPolisiRate["13_anti_huru_hara"], key: "13_anti_huru_hara", groupId: "khusus", icon: ShieldAlert, biaya_pembangunan: (armadaPolisiRate["13_anti_huru_hara"].biaya_pembangunan) / 1000, waktu_pembangunan: armadaPolisiRate["13_anti_huru_hara"].waktu_pembangunan, konsumsi_listrik: armadaPolisiRate["13_anti_huru_hara"].get_konsumsi_listrik?.() || armadaPolisiRate["13_anti_huru_hara"].konsumsi_listrik || 0, deskripsi: armadaPolisiRate["13_anti_huru_hara"].deskripsi, count: (currentData.armada_kepolisian?.armada_polisi?.samapta || 0) + ((buildingDeltas["samapta"] as number) || 0) },
      ]
    }
  ];
