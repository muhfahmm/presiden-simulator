...
import { X, Wrench, Zap, Shield, Truck, MapPin, Gavel, TowerControl, Ship, Rocket, Activity, TrendingUp, TrendingDown, Clock, Loader2, Eye, EyeOff, Building, Archive, Info, Briefcase, Users, Flame, Landmark, ShieldAlert, Layers, Hammer, TreePine } from "lucide-react"
          ...
          <div className="absolute inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-[32px] shadow-2xl max-w-md w-full mx-4 flex flex-col items-center text-center gap-6 animate-in zoom-in-95">
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-400 text-sm font-medium leading-relaxed">Anda akan membangun <span className="text-white font-black underline">{confirmBuild.label}</span> untuk memperkuat infrastruktur pertahanan nasional.</p>
              </div>
              ...
              <div className="w-full grid grid-cols-3 gap-3">
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center gap-1 group">
                  ...
                  <span className="text-xl font-black text-amber-500 group-hover:scale-110 transition-transform duration-300 tracking-tight">{(confirmBuild.biaya_pembangunan * quantity).toLocaleString('id-ID')}</span>
                </div>
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center gap-1 group">
                ...
                <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center gap-1 group">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-black text-rose-500 group-hover:scale-110 transition-transform duration-300 tracking-tight">{((confirmBuild.konsumsi_listrik || 0) * quantity).toLocaleString('id-ID')} MW</span>
                  </div>
                </div>
              </div>
