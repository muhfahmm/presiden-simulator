            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-[40px] shadow-2xl max-w-4xl w-full mx-4 flex flex-col gap-6 animate-in zoom-in-95 max-h-[90vh]">
              ...
              <div className="flex items-center gap-6 shrink-0 border-b border-zinc-800/50 pb-6">
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-zinc-400 text-sm font-medium mt-2">Membangun <span className="text-white font-black underline">{confirmBuild.label}</span> untuk memperkuat infrastruktur pertahanan nasional.</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col gap-3">
                      <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest italic leading-none ml-1">Spesifikasi Infrastruktur</span>
