...
def decide():
    try:
        ...
        options = [o for o in input_data.get("options", []) if o.get("groupId") in ["infra_darat", "perkeretaapian", "maritim_udara"]]
        ...
        if affordable and metrics.get("infrastructure_index", 100) < 90:
