  ...
  const publicGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: "tk_sd", groupId: "pendidikan", label: "TK / SD", icon: Building2, desc: "Pendidikan", tarif: 1, unit: "Unit", cost: 13, buildTime: 40, maintenanceCost: 2, count: (currentData.sektor_sosial.pendidikan.tk + currentData.sektor_sosial.pendidikan.sd) + ((buildingDeltas["tk_sd"] as number) || 0), consumption: (KONSUMSI_SOSIAL.pendidikan.tk + KONSUMSI_SOSIAL.pendidikan.sd) / 2 },
        { key: "smp_sma", groupId: "pendidikan", label: "SMP / SMA", icon: Library, desc: "Pendidikan", tarif: 1, unit: "Unit", cost: 32, buildTime: 60, maintenanceCost: 5, count: (currentData.sektor_sosial.pendidikan.smp + currentData.sektor_sosial.pendidikan.sma) + ((buildingDeltas["smp_sma"] as number) || 0), consumption: (KONSUMSI_SOSIAL.pendidikan.smp + KONSUMSI_SOSIAL.pendidikan.sma) / 2 },
        { key: "pt_lembaga", groupId: "pendidikan", label: "PT / Lembaga", icon: Library, desc: "Pendidikan", tarif: 1, unit: "Unit", cost: 230, buildTime: 150, maintenanceCost: 20, count: (currentData.sektor_sosial.pendidikan.universitas + currentData.sektor_sosial.pendidikan.lembaga_pendidikan) + ((buildingDeltas["pt_lembaga"] as number) || 0), consumption: (KONSUMSI_SOSIAL.pendidikan.universitas + KONSUMSI_SOSIAL.pendidikan.lembaga_pendidikan) / 2 },
        { key: "lab_riset", groupId: "pendidikan", label: "Lab & Riset", icon: Microscope, desc: "Riset", tarif: 1, unit: "Unit", cost: 290, buildTime: 120, maintenanceCost: 30, count: (currentData.sektor_sosial.pendidikan.laboratorium + currentData.sektor_sosial.pendidikan.pusat_penelitian) + ((buildingDeltas["lab_riset"] as number) || 0), consumption: (KONSUMSI_SOSIAL.pendidikan.laboratorium + KONSUMSI_SOSIAL.pendidikan.pusat_penelitian) / 2 },
        ...
        { key: "kolam_renang", groupId: "kesehatan", label: "Kolam Renang", icon: Waves, desc: "Olahraga", tarif: 1, unit: "Unit", cost: 15, buildTime: 30, maintenanceCost: 3, count: (currentData.sektor_sosial.olahraga.kolam_renang || 0) + ((buildingDeltas["kolam_renang"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.kolam_renang },
        { key: "sirkuit_balap", groupId: "kesehatan", label: "Sirkuit Balap", icon: Flame, desc: "Olahraga", tarif: 1, unit: "Unit", cost: 250, buildTime: 180, maintenanceCost: 40, count: (currentData.sektor_sosial.olahraga.sirkuit_balap || 0) + ((buildingDeltas["sirkuit_balap"] as number) || 0), consumption: KONSUMSI_SOSIAL.olahraga.sirkuit_balap },
        { key: "stadium_int", groupId: "kesehatan", label: "Stadion (Nas/Int)", icon: Trophy, desc: "Olahraga", tarif: 1, unit: "Unit", cost: 670, buildTime: 240, maintenanceCost: 60, count: (currentData.sektor_sosial.olahraga.stadion + currentData.sektor_sosial.olahraga.stadion_internasional) + ((buildingDeltas["stadium_int"] as number) || 0), consumption: (KONSUMSI_SOSIAL.olahraga.stadion + KONSUMSI_SOSIAL.olahraga.stadion_internasional) / 2 },
        ...
        { key: "stasiun_komando", groupId: "hukum", label: "Pusat Komando", icon: Siren, desc: "Keamanan", tarif: 1, unit: "Unit", cost: 80, buildTime: 45, maintenanceCost: 12, count: (currentData.sektor_keamanan.armada_polisi.pusat_komando.kantor_polisi || 0) + ((buildingDeltas["stasiun_komando"] as number) || 0), consumption: KONSUMSI_SOSIAL.hukum.pos_polisi },
      ]
    }
  ];
