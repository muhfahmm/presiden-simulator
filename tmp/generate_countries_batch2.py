...
# Mapping for Batch 2: D-G
country_map = {
    "denmark": {"en": "Denmark", "continent": "eropa"},
    "dominika": {"en": "Dominica", "continent": "na"},
    "ekuador": {"en": "Ecuador", "continent": "sa"},
    "el salvador": {"en": "El Salvador", "continent": "na"},
    "eritrea": {"en": "Eritrea", "continent": "afrika"},
    "estonia": {"en": "Estonia", "continent": "eropa"},
    "ethiopia": {"en": "Ethiopia", "continent": "afrika"},
    "fiji": {"en": "Fiji", "continent": "oceania"},
    "filipina": {"en": "Philippines", "continent": "asia"},
    "finlandia": {"en": "Finland", "continent": "eropa"},
    "gabon": {"en": "Gabon", "continent": "afrika"},
    "gambia": {"en": "Gambia", "continent": "afrika"},
    "georgia": {"en": "Georgia", "continent": "asia"},
    "ghana": {"en": "Ghana", "continent": "afrika"}
}

base_dir = r"c:\fhm\EM4\app\frontend-desktop\src\app\select-country\data\countries"
# Use original template, already valid
...
print("Synchronized all listings.")
