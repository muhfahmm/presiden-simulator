    ...
    if match:
        ...
        for name, dcontent in items:
            ...
            if nodes:
                ...
                results.append(f"    First 3 Coords: {nodes[:3]}")

with open(r"c:\fhm\EM4\tmp\gulf_mesh_dump.txt", 'w', encoding='utf-8') as f:
    f.write("\n".join(results))

print("Gulf mesh dump written to file.")
