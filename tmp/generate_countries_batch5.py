...
# Mapping for Batch 5: K-K2
# Map Indonesian -> English Name, Continent Code
country_map = {
    "kamerun": {"en": "Cameroon", "continent": "afrika"},
    "kanada": {"en": "Canada", "continent": "na"},
    "kazakhstan": {"en": "Kazakhstan", "continent": "asia"},
    "kenya": {"en": "Kenya", "continent": "afrika"},
    "kirgizstan": {"en": "Kyrgyzstan", "continent": "asia"},
    "kiribati": {"en": "Kiribati", "continent": "oceania"},
    "kolombia": {"en": "Colombia", "continent": "sa"},
    "komoro": {"en": "Comoros", "continent": "afrika"},
    "kongo": {"en": "Republic of the Congo", "continent": "afrika"},
    "korea selatan": {"en": "South Korea", "continent": "asia"}
}
...
for id_name, meta in country_map.items():
    ...
    for c in countries_data:
        ...
        # Exact match or fuzzy list include
        if en_name.lower() in names or id_name.lower() in names:
            match = c
            break
        # Special case South Korea
        if id_name == "korea selatan" and "republic of korea" in "".join(names).lower():
            match = c
            break
...
print("Synchronized all listings batch 5.")
