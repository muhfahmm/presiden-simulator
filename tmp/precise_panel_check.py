...
print("LEFT SECTION TAG TRACE [173 - 316]:")
for i in range(172, 316): # 0-indexed
    line = lines[i].split("//")[0]
    
    # Strip parameters inside tags that might carry '<' or '>'
    # Better: find tag names directly
    ...
    for match in matches:
         ...
         if not is_close and "/>" in line:
              # Very primitive check, only works for inline single line
...
print("\n--- REMAINING OPEN TAGS AT ROW 316 ---")
print(tag_stack)
