...
# Mapping for Batch 4: I-K
country_map = {
    "irak": {"en": "Iraq", "continent": "asia"},
    "iran": {"en": "Iran", "continent": "asia"},
    "irlandia": {"en": "Ireland", "continent": "eropa"},
    "israel": {"en": "Israel", "continent": "asia"},
    "italia": {"en": "Italy", "continent": "eropa"},
    "jamaika": {"en": "Jamaica", "continent": "na"},
    "jepang": {"en": "Japan", "continent": "asia"},
    "jerman": {"en": "Germany", "continent": "eropa"},
    "yordania": {"en": "Jordan", "continent": "asia"},
    "kamboja": {"en": "Cambodia", "continent": "asia"}
}
...
for id_name, meta in country_map.items():
    ...
    # Use standard Regex replace for Metadata safely
    ...
    # capitalize every word for correct UI mapping if needed? No, title case is fine!
...
print("Synchronized all listings batch 4.")
