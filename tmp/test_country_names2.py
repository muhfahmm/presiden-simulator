...
search_list = [
    "san marino", "sao tome", "principe", "singapore", "slovakia", "spain", 
    "sri lanka", "south sudan", "syria", "sweden", "switzerland", "taiwan", 
    "tahiti", "french polynesia"
]

with open(r'c:\fhm\EM4\tmp\test_output_2.txt', 'w', encoding='utf-8') as f_out:
    f_out.write("Matches:\n")
    for c in data:
