...
# Mapping for Batch 3: G-I
country_map = {
    "grenada": {"en": "Grenada", "continent": "na"},
    "guatemala": {"en": "Guatemala", "continent": "na"},
    "guinea": {"en": "Guinea", "continent": "afrika"},
    "guinea-bissau": {"en": "Guinea-Bissau", "continent": "afrika"},
    "guyana": {"en": "Guyana", "continent": "sa"},
    "haiti": {"en": "Haiti", "continent": "na"},
    "honduras": {"en": "Honduras", "continent": "na"},
    "hungaria": {"en": "Hungary", "continent": "eropa"},
    "islandia": {"en": "Iceland", "continent": "eropa"},
    "india": {"en": "India", "continent": "asia"},
    "indonesia": {"en": "Indonesia", "continent": "asia"}
}
...
for id_name, meta in country_map.items():
    ...
    # Handle hyphens along with spaces
...
print("Synchronized all listings batch 3.")
